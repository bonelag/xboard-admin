!(function () {
    ...
    class g {
        ...
        add(e) {
            if (!e || e === p.None) return e;
            if (e === this)
                throw new Error("Cannot register a disposable on itself!");
            return (this._isDisposed || this._toDispose.add(e), e);
        }
        delete(e) {
            if (e) {
                if (e === this)
    ...
    class b {
        static {
            this.Undefined = new b(void 0);
        }
        constructor(e) {
            ((this.element = e),
                (this.next = b.Undefined),
                (this.prev = b.Undefined));
        }
    }
    class y {
        constructor() {
            ((this._first = b.Undefined),
                (this._last = b.Undefined),
                (this._size = 0));
        }
        get size() {
            return this._size;
        ...
        _remove(e) {
            if (e.prev !== b.Undefined && e.next !== b.Undefined) {
                const t = e.prev;
    ...
    !(function (e) {
                ...
                onWillAddFirstListener() {
                    a = e((e) => {
                        (h++,
                            ...
                            "number" == typeof n
                                ? (u && clearTimeout(u), (u = setTimeout(c, n)))
                                : void 0 === u &&
                                ((u = null), queueMicrotask(c)));
                    });
                },
        ...
        class l {
            constructor(e, t) {
                ...
                ((this.emitter = new A(n)), t && t.add(this.emitter));
            }
            beginUpdate(e) {
                this._counter++;
            }
    ...
    class L {
        ...
        constructor(e, t, n = (L._idPool++).toString(16).padStart(3, "0")) {
    ...
    class A {
                ...
                (this._event ??= (e, n, r) => {
                    if (
                        ...
                        const e = `[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far (${this._size} vs ${this._leakageMon.threshold})`,
                            n = this._leakageMon.getMostFrequentStack() ?? [
                                "UNKNOWN stack",
                                -1,
                            ],
                            r = new x(
                                `${e}. HINT: Stack shows most frequent listener (${n[1]}-times)`,
                                n[0],
                            );
                        return (
                            (this._options?.onListenerError || t)(r),
                            p.None
                        );
                    }
                    if (this._disposed) return p.None;
                    n && (e = e.bind(n));
                    const i = new E(e);
                    let s;
                    (this._leakageMon &&
        ...
        fire(e) {
            if (
                ...
                if (this._listeners instanceof E)
                    this._deliver(this._listeners, e);
                else {
                    const t = this._deliveryQueue;
                    (t.enqueue(this, e, this._listeners.length),
                        this._deliverQueue(t));
                }
            else;
            this._perfMon?.stop();
        }
    ...
    const T =
        ...
        ("undefined" != typeof document &&
            document.location &&
            "string" == typeof document.location.hash &&
    ...
    const U = globalThis;
    let j;
    void 0 !== U.vscode && void 0 !== U.vscode.process
        ? (j = U.vscode.process)
        : "undefined" != typeof process &&
        "string" == typeof process?.versions?.node &&
        (j = process);
    const W =
        "string" == typeof j?.versions?.electron && "renderer" === j?.type;
    if ("object" == typeof j) {
        ((D = "win32" === j.platform),
            (q = "darwin" === j.platform),
            (K = "linux" === j.platform),
            K && j.env.SNAP && j.env.SNAP_REVISION,
            j.env.CI ||
            j.env.BUILD_ARTIFACTSTAGINGDIRECTORY ||
            j.env.GITHUB_WORKSPACE,
            (P = I),
            ($ = I));
        ...
        if (e)
            try {
                ...
                ((P = t.userLocale),
                    (B = t.osLocale),
                    ($ = t.resolvedLanguage || I),
                    (F = t.languagePack?.translationsConfigFile));
            } catch (Pl) { }
    } else
        "object" != typeof navigator ||
            W ||
            ((V = navigator.userAgent),
                (D = V.indexOf("Windows") >= 0),
                (q = V.indexOf("Macintosh") >= 0),
                ...
                V?.indexOf("Mobi"),
                ($ = R() || I),
                (P = navigator.language.toLowerCase()),
                (B = P));
    const z = D,
        H = q,
        G = V,
        J = "function" == typeof U.postMessage && !U.importScripts;
    (() => {
        if (J) {
            const e = [];
    ...
    const X = !!(G && G.indexOf("Chrome") >= 0);
    function Q(e) {
        return e;
    }
    (G && G.indexOf("Firefox"),
        !X && G && G.indexOf("Safari"),
        G && G.indexOf("Edg/"),
        G && G.indexOf("Android"));
    class Z {
        constructor(e, t) {
    ...
    class oe {
        static {
            this.ambiguousCharacterData = new ee(() =>
                JSON.parse(
        ...
        static {
            this.cache = new Z({ getCacheKey: JSON.stringify }, (e) => {
                function t(e) {
                    const t = new Map();
                ...
                let i,
                    s = e.filter(
                        (e) => !e.startsWith("_") && Object.hasOwn(r, e),
                    );
    ...
    class me {
        ...
        async sendMessage(e, t, n) {
            ...
            return new Promise((i, s) => {
                ((this._pendingReplies[r] = { resolve: i, reject: s }),
                    this._send(new ue(this._workerId, r, e, t, n)));
            });
        }
        listen(e, t, n) {
            let r = null;
            const i = new A({
                onWillAddFirstListener: () => {
                    ((r = String(++this._lastSentReq)),
                        ...
                        this._send(new he(this._workerId, r, e, t, n)));
                },
                onDidRemoveLastListener: () => {
                    (this._pendingEmitters.delete(r),
                        this._send(new fe(this._workerId, r)),
                        (r = null));
                },
            });
            return i.event;
        ...
        _handleRequestMessage(e) {
            ...
            this._handler.handleMessage(e.channel, e.method, e.args).then(
                ...
                (e) => {
                    (e.detail instanceof Error && (e.detail = n(e.detail)),
                        this._send(new ce(this._workerId, t, void 0, n(e))));
                },
            );
        }
        _handleSubscribeEventMessage(e) {
            const t = e.req,
                n = this._handler.handleEvent(
                    ...
                    this._send(new de(this._workerId, t, e));
                });
    ...
    function ge(e) {
        return "o" === e[0] && "n" === e[1] && te(e.charCodeAt(2));
    }
    function pe(e) {
        return /^onDynamic/.test(e) && te(e.charCodeAt(9));
    }
    class be {
        constructor(e, t) {
            ((this._localChannels = new Map()),
                (this._remoteChannels = new Map()),
                (this._protocol = new me({
                    sendMessage: (t, n) => {
                        e(t, n);
                    },
        ...
        _handleMessage(e, t, n) {
            if (e === le && "$initialize" === t) return this.initialize(n[0]);
            const r =
                e === le ? this.requestHandler : this._localChannels.get(e);
            if (!r)
            ...
            if ("function" != typeof i)
                return Promise.reject(
                    new Error(
                        `Missing method ${t} on worker thread channel ${e}`,
                    ),
                );
            try {
                return Promise.resolve(i.apply(r, n));
            } catch (Pl) {
                return Promise.reject(Pl);
            }
        }
        _handleEvent(e, t, n) {
            const r =
    ...
    function Ce(e, t) {
        t = we(149417, t);
        for (let n = 0, r = e.length; n < r; n++) t = we(e.charCodeAt(n), t);
        return t;
    }
    new ee(() => new Uint8Array(256));
    class _e {
        constructor(e) {
            this.source = e;
        }
    ...
    function Le(e, t, n) {
        return new Ee(new _e(e), new _e(t)).ComputeDiff(n).changes;
    }
    class Se {
        static Assert(e, t) {
    ...
    class Ee {
        constructor(e, t, n = null) {
            ...
            const [r, i, s] = Ee._getElements(e),
                [o, a, l] = Ee._getElements(t);
        ...
        static _getElements(e) {
            ...
            if (Ee._isStringArray(t)) {
                const e = new Int32Array(t.length);
                for (let n = 0, r = t.length; n < r; n++) e[n] = Ce(t[n], 0);
                return [t, e, !0];
            }
        ...
        ElementsAreStrictEqual(e, t) {
            ...
            return (
                Ee._getStrictElement(this._originalSequence, e) ===
                Ee._getStrictElement(this._modifiedSequence, t)
            );
        }
        ...
        ComputeDiffRecursive(e, t, n, r, i) {
            ...
            const s = [0],
                o = [0],
                a = this.ComputeRecursionPoint(e, t, n, r, s, o, i),
                l = s[0],
                u = o[0];
            if (null !== a) return a;
            if (!i[0]) {
        ...
        WALKTRACE(e, t, n, r, i, s, o, a, l, u, c, h, d, f, m, g, p, b) {
            ...
            do {
                ...
                (t === C || (t < _ && l[t - 1] < l[t + 1])
                    ? ((f = (c = l[t + 1]) - L - r),
                        c < S && w.MarkNextChange(),
                        (S = c),
                        w.AddModifiedElement(c + 1, f),
                        (L = t + 1 - e))
                    : ((f = (c = l[t - 1] + 1) - L - r),
                        c < S && w.MarkNextChange(),
                        (S = c - 1),
                        w.AddOriginalElement(c, f + 1),
                        (L = t - 1 - e)),
                    N >= 0 &&
                    ((e = (l = this.m_forwardHistory[N])[0]),
                        (C = 1),
                        (_ = l.length - 1)));
            } while (--N >= -1);
                ...
                do {
                    ...
                    (e === C || (e < _ && u[e - 1] >= u[e + 1])
                        ? ((f = (c = u[e + 1] - 1) - L - a),
                            c > S && w.MarkNextChange(),
                            (S = c + 1),
                            w.AddOriginalElement(c + 1, f + 1),
                            (L = e + 1 - i))
                        : ((f = (c = u[e - 1]) - L - a),
                            c > S && w.MarkNextChange(),
                            (S = c),
                            w.AddModifiedElement(c + 1, f + 1),
                            (L = e - 1 - i)),
                        N >= 0 &&
                        ((i = (u = this.m_reverseHistory[N])[0]),
                            (C = 1),
                            (_ = u.length - 1)));
                } while (--N >= -1);
                v = w.getChanges();
        ...
        ComputeRecursionPoint(e, t, n, r, i, s, o) {
            ...
            const f = t - e + (r - n),
                ...
                C = (y - b) % 2 == 0;
            ((g[b] = e), (p[y] = t), (o[0] = !1));
            for (let _ = 1; _ <= f / 2 + 1; _++) {
                let f = 0,
                    L = 0;
                ((u = this.ClipDiagonalBound(b - _, _, b, m)),
                    (c = this.ClipDiagonalBound(b + _, _, b, m)));
                for (let e = u; e <= c; e += 2) {
                    ((a =
                        e === u || (e < c && g[e - 1] < g[e + 1])
                            ? g[e + 1]
                    ...
                    for (
                        ;
                        a < t && l < r && this.ElementsAreEqual(a + 1, l + 1);
                    )
                        (a++, l++);
                    if (
                        ((g[e] = a),
                            a + l > f + L && ((f = a), (L = l)),
                            !C && Math.abs(e - y) <= _ - 1 && a >= p[e])
                    )
                        return (
                            (i[0] = a),
                            (s[0] = l),
                ...
                if (
                    ...
                    !this.ContinueProcessingPredicate(f, S)
                )
                    return (
                        (o[0] = !0),
                        (i[0] = f),
                ...
                ((h = this.ClipDiagonalBound(y - _, _, y, m)),
                    (d = this.ClipDiagonalBound(y + _, _, y, m)));
                for (let m = h; m <= d; m += 2) {
                    ((a =
                        m === h || (m < d && p[m - 1] >= p[m + 1])
                            ? p[m + 1] - 1
                    ...
                    for (; a > e && l > n && this.ElementsAreEqual(a, l);)
                        (a--, l--);
                    if (((p[m] = a), C && Math.abs(m - b) <= _ && a <= g[m]))
                        return (
                            (i[0] = a),
                            (s[0] = l),
                            f >= g[m] && _ <= 1448
                ...
                if (_ <= 1447) {
                    ...
                    ((e[0] = b - u + 1),
                        Ne.Copy2(g, u, e, 1, c - u + 1),
                        this.m_forwardHistory.push(e),
                        (e = new Int32Array(d - h + 2)),
                        (e[0] = y - h + 1),
                        Ne.Copy2(p, h, e, 1, d - h + 1),
        ...
        PrettifyChanges(e) {
            ...
            for (let t = e.length - 1; t >= 0; t--) {
                ...
                for (let e = 1; ; e++) {
                    ...
                    if (
                        o &&
                        !this.ModifiedElementsAreEqual(u, u + n.modifiedLength)
                    )
                        break;
                    const c =
                        (t === r && u === i ? 5 : 0) +
            ...
            if (this._hasStrings)
                for (let t = 1, n = e.length; t < n; t++) {
                    const n = e[t - 1],
                        ...
                        c = u - l;
                    if (i < 5 && a < 20 && c < 20) {
                        const e = this._findBetterContiguousSequence(
                            s,
                            a,
                            l,
                            c,
        ...
        ConcatenateChanges(e, t) {
            ...
            if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
                ...
                return (
                    Ne.Copy(e, 0, r, 0, e.length - 1),
                    (r[e.length - 1] = n[0]),
                    Ne.Copy(t, 1, r, e.length, t.length - 1),
                    r
                );
            }
            {
                ...
                return (
                    Ne.Copy(e, 0, n, 0, e.length),
                    Ne.Copy(t, 0, n, e.length, t.length),
                    n
                );
            }
        }
    ...
    let Ae = class e {
        ...
        ke = class e {
            ...
            static getEndPosition(e) {
                return new Ae(e.endLineNumber, e.endColumn);
            }
            getStartPosition() {
                return e.getStartPosition(this);
            }
            static getStartPosition(e) {
                return new Ae(e.startLineNumber, e.startColumn);
            }
            toString() {
                return (
                    "[" +
            ...
            static areOnlyIntersecting(e, t) {
                return (
                    !(
                        ...
                        (e.endLineNumber === t.startLineNumber &&
                            e.endColumn < t.startColumn - 1)
                    ) &&
                    !(
                        t.endLineNumber < e.startLineNumber - 1 ||
                        (t.endLineNumber === e.startLineNumber &&
                            t.endColumn < e.startColumn - 1)
                    )
                );
            }
    ...
    class Me {
        constructor(e) {
            ...
            ((this._defaultValue = t),
                (this._asciiMap = Me._createAsciiMap(t)),
                (this._map = new Map()));
        }
            ...
            const n = (function () {
                if (null === Fe) {
                    ...
                    for (let n = 0; n < e.length; n++)
                        Fe.set(e.charCodeAt(n), 1);
                    const t = ".,;:";
                    for (let n = 0; n < t.length; n++)
                        Fe.set(t.charCodeAt(n), 2);
                }
                return Fe;
            })(),
                r = [];
            for (let i = 1, s = e.getLineCount(); i <= s; i++) {
                ...
                for (; a < o;) {
                    ...
                    if (13 === c) {
                        ...
                        1 === t &&
                            (r.push(Ve._createLink(n, s, i, l, a)), (e = !0));
                    } else if (12 === c) {
                        let t;
                ...
                13 === c && r.push(Ve._createLink(n, s, i, l, o));
            }
            return r;
        }
    }
    class De {
        ...
        valueSetsReplace(e, t, n) {
            let r = null;
            for (let i = 0, s = e.length; null === r && i < s; i++)
    ...
    !(function (e) {
        ((e.isCancellationToken = function (t) {
            ...
            (e.None = Object.freeze({
                ...
                onCancellationRequested: C.None,
            })),
    ...
    class $e {
        ...
        get onCancellationRequested() {
            return this._isCancelled
                ? qe
                : (this._emitter || (this._emitter = new A()),
                    this._emitter.event);
        }
        dispose() {
    ...
    (!(function () {
        ...
        for (const i of t) {
            ...
            if (
                ...
                if (((n[o] = !0), !a))
                    throw new Error(
                        `String representation missing for key code ${o} around scan code ${s}`,
                    );
                (je.define(o, a),
                    We.define(o, c || a),
                    ze.define(o, h || c || a));
    ...
    var Qe = {};
    let Ze;
    const Ye = globalThis.vscode;
    if (void 0 !== Ye && void 0 !== Ye.process) {
        const e = Ye.process;
        Ze = {
            get platform() {
                return e.platform;
    ...
    function lt(e, t) {
        if ("string" != typeof e) throw new at(t, "string", e);
    }
    const ut = "win32" === nt;
    function ct(e) {
        return e === it || e === st;
    ...
    function mt(e, t) {
        !(function (e, t) {
            if (null === e || "object" != typeof e)
                throw new at(t, "Object", e);
        })(t, "pathObject");
        const n = t.dir || t.root,
            r =
                t.base ||
                `${t.name || ""}${((i = t.ext), i ? `${"." === i[0] ? "" : "."}${i}` : "")}`;
        var i;
    ...
    const gt = {
        resolve(...e) {
            ...
            for (let i = e.length - 1; i >= -1; i--) {
                ...
                if (1 === o) ct(c) && ((a = 1), (u = !0));
                    ...
                    if (((u = !0), ct(s.charCodeAt(1)))) {
                        let e = 2,
                            t = e;
                        for (; e < o && !ct(s.charCodeAt(e));) e++;
                        if (e < o && e !== t) {
                            const n = s.slice(t, e);
                            for (t = e; e < o && ct(s.charCodeAt(e));) e++;
                            if (e < o && e !== t) {
                                for (t = e; e < o && !ct(s.charCodeAt(e));)
                                    e++;
                                (e !== o && e === t) ||
                                    ((l = `\\\\${n}\\${s.slice(t, e)}`),
                                        (a = e));
        ...
        normalize(e) {
            ...
            if (1 === t) return ht(s) ? "\\" : e;
            if (ct(s))
                if (((i = !0), ct(e.charCodeAt(1)))) {
                    let i = 2,
                        s = i;
                    for (; i < t && !ct(e.charCodeAt(i));) i++;
                    if (i < t && i !== s) {
                        const o = e.slice(s, i);
                        for (s = i; i < t && ct(e.charCodeAt(i));) i++;
                        if (i < t && i !== s) {
                            for (s = i; i < t && !ct(e.charCodeAt(i));)
                                i++;
                ...
                dt(s) &&
                    ...
                    ((n = e.slice(0, 2)),
                        (r = 2),
                        t > 2 && ct(e.charCodeAt(2)) && ((i = !0), (r = 3)));
            let o = r < t ? ft(e.slice(r), !i, "\\", ct) : "";
            if (
                (0 !== o.length || i || (o = "."),
                    o.length > 0 && ct(e.charCodeAt(t - 1)) && (o += "\\"),
        ...
        join(...e) {
            ...
            let r = !0,
                i = 0;
            if ("string" == typeof n && ct(n.charCodeAt(0))) {
                ++i;
                const e = n.length;
                e > 1 &&
                    ct(n.charCodeAt(1)) &&
                    (++i, e > 2 && (ct(n.charCodeAt(2)) ? ++i : (r = !1)));
            }
            if (r) {
                for (; i < t.length && ct(t.charCodeAt(i));) i++;
                i >= 2 && (t = `\\${t.slice(i)}`);
            }
            return gt.normalize(t);
        },
        relative(e, t) {
            if ((lt(e, "from"), lt(t, "to"), e === t)) return "";
            const n = gt.resolve(e),
                r = gt.resolve(t);
            if (n === r) return "";
        ...
        dirname(e) {
            ...
            if (1 === t) return ct(i) ? e : ".";
            if (ct(i)) {
                if (((n = r = 1), ct(e.charCodeAt(1)))) {
                    let i = 2,
                        s = i;
                    for (; i < t && !ct(e.charCodeAt(i));) i++;
                    if (i < t && i !== s) {
                ...
                dt(i) &&
                    e.charCodeAt(1) === ot &&
                    ((n = t > 2 && ct(e.charCodeAt(2)) ? 3 : 2), (r = n));
            let s = -1,
                o = !0;
            for (let a = t - 1; a >= r; --a)
                if (ct(e.charCodeAt(a))) {
                    if (!o) {
                        s = a;
                        break;
                    }
        ...
        parse(e) {
            ...
            if (1 === n)
                return ct(i)
                    ...
                    : ((t.base = t.name = e), t);
            if (ct(i)) {
                if (((r = 1), ct(e.charCodeAt(1)))) {
                    let t = 2,
                        i = t;
                    for (; t < n && !ct(e.charCodeAt(t));) t++;
                    if (t < n && t !== i) {
                        for (i = t; t < n && ct(e.charCodeAt(t));) t++;
                        if (t < n && t !== i) {
                            for (i = t; t < n && !ct(e.charCodeAt(t));)
                                t++;
                            t === n ? (r = t) : t !== i && (r = t + 1);
                        }
                    }
                }
            } else if (dt(i) && e.charCodeAt(1) === ot) {
                if (n <= 2) return ((t.root = t.dir = e), t);
                if (((r = 2), ct(e.charCodeAt(2)))) {
        ...
        bt = {
            ...
            normalize(e) {
                if ((lt(e, "path"), 0 === e.length)) return ".";
                const t = e.charCodeAt(0) === it,
                    n = e.charCodeAt(e.length - 1) === it;
                return 0 === (e = ft(e, !t, "/", ht)).length
                    ? t
                        ? "/"
                        : n
                            ? "./"
            ...
            join(...e) {
                ...
                for (let n = 0; n < e.length; ++n) {
                    const r = e[n];
                    (lt(r, "path"), r.length > 0 && t.push(r));
                }
                return 0 === t.length ? "." : bt.normalize(t.join("/"));
            },
            relative(e, t) {
                if ((lt(e, "from"), lt(t, "to"), e === t)) return "";
                if ((e = bt.resolve(e)) === (t = bt.resolve(t))) return "";
                const n = e.length,
                    r = n - 1,
                    i = t.length - 1,
                    s = r < i ? r : i;
    ...
    ((bt.win32 = gt.win32 = gt),
        ...
        ut ? gt.normalize : bt.normalize,
        ut ? gt.resolve : bt.resolve,
        ut ? gt.relative : bt.relative,
        ut ? gt.dirname : bt.dirname,
        ut ? gt.basename : bt.basename,
        ut ? gt.extname : bt.extname,
        ut ? gt.sep : bt.sep);
    const yt = /^\w[\w\d+.-]*$/,
        vt = /^\//,
        wt = /^\/\//;
    ...
    let St = class e {
        ...
        constructor(e, t, n, r, i, s = !1) {
            "object" == typeof e
                ? ((this.scheme = e.scheme || Ct),
                    (this.authority = e.authority || Ct),
                    (this.path = e.path || Ct),
                    (this.query = e.query || Ct),
                    (this.fragment = e.fragment || Ct))
        ...
        with(e) {
            ...
            return (
                void 0 === t ? (t = this.scheme) : null === t && (t = Ct),
                void 0 === n ? (n = this.authority) : null === n && (n = Ct),
                void 0 === r ? (r = this.path) : null === r && (r = Ct),
                void 0 === i ? (i = this.query) : null === i && (i = Ct),
                void 0 === s ? (s = this.fragment) : null === s && (s = Ct),
                t === this.scheme &&
                    n === this.authority &&
                    r === this.path &&
                    i === this.query &&
        ...
        static parse(e, t = !1) {
            ...
            return n
                ...
                : new xt(Ct, Ct, Ct, Ct, Ct);
        }
        static file(e) {
            let t = Ct;
            if ((z && (e = e.replace(/\\/g, _t)), e[0] === _t && e[1] === _t)) {
                const n = e.indexOf(_t, 2);
                -1 === n
                    ? ((t = e.substring(2)), (e = _t))
                    : ((t = e.substring(2, n)), (e = e.substring(n) || _t));
            }
            return new xt("file", t, e, Ct, Ct);
        }
        static from(e, t) {
            return new xt(
                e.scheme,
            ...
            if (t) {
                if (t instanceof e) return t;
                {
                    ...
                    return (
                        ...
                        (e._fsPath = t._sep === Nt ? (t.fsPath ?? null) : null),
                        e
                    );
                }
            }
    ...
    class xt extends St {
        ...
        get fsPath() {
            return (
                this._fsPath || (this._fsPath = Rt(this, !1)),
                this._fsPath
            );
        }
        toString(e = !1) {
        ...
        toJSON() {
            const e = { $mid: 1 };
            return (
                this._fsPath && ((e.fsPath = this._fsPath), (e._sep = Nt)),
    ...
    function At(e, t, n) {
        ...
        for (let s = 0; s < e.length; s++) {
            ...
            if (
                ...
                (-1 !== i &&
                    ((r += encodeURIComponent(e.substring(i, s))), (i = -1)),
    ...
    function kt(e) {
        ...
        for (let n = 0; n < e.length; n++) {
            const r = e.charCodeAt(n);
            35 === r || 63 === r
                ? (void 0 === t && (t = e.substr(0, n)), (t += Et[r]))
                : void 0 !== t && (t += e[n]);
        }
        return void 0 !== t ? t : e;
    }
    ...
    function Tt(e, t) {
        ...
        if (
            ...
            ((s = s.toLowerCase()),
                ...
                -1 === e
                    ? (r += n(s, !1, !0))
                    : ((r += n(s.substr(0, e), !1, !0)), (r += s.substr(e))));
        }
        if (o) {
            if (
                o.length >= 3 &&
    ...
    function Mt(e) {
        try {
            ...
            return e.length > 3 ? e.substr(0, 3) + Mt(e.substr(3)) : e;
        }
    }
    const Ot = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function It(e) {
        return e.match(Ot) ? e.replace(Ot, (e) => Mt(e)) : e;
    }
    class Pt extends ke {
        constructor(e, t, n, r) {
            (super(e, t, n, r),
        ...
        getPosition() {
            return new Ae(this.positionLineNumber, this.positionColumn);
        }
        getSelectionStart() {
            return new Ae(
                this.selectionStartLineNumber,
    ...
    const Dt = {
        ...{
            add: Vt("add", 6e4),
            plus: Vt("plus", 6e4),
            gistNew: Vt("gist-new", 6e4),
            repoCreate: Vt("repo-create", 6e4),
            lightbulb: Vt("lightbulb", 60001),
            lightBulb: Vt("light-bulb", 60001),
            repo: Vt("repo", 60002),
            repoDelete: Vt("repo-delete", 60002),
            gistFork: Vt("gist-fork", 60003),
            repoForked: Vt("repo-forked", 60003),
            gitPullRequest: Vt("git-pull-request", 60004),
            gitPullRequestAbandoned: Vt("git-pull-request-abandoned", 60004),
            recordKeys: Vt("record-keys", 60005),
            keyboard: Vt("keyboard", 60005),
            tag: Vt("tag", 60006),
            gitPullRequestLabel: Vt("git-pull-request-label", 60006),
            tagAdd: Vt("tag-add", 60006),
            tagRemove: Vt("tag-remove", 60006),
            person: Vt("person", 60007),
            personFollow: Vt("person-follow", 60007),
            personOutline: Vt("person-outline", 60007),
            personFilled: Vt("person-filled", 60007),
            sourceControl: Vt("source-control", 60008),
            mirror: Vt("mirror", 60009),
            mirrorPublic: Vt("mirror-public", 60009),
            star: Vt("star", 60010),
            starAdd: Vt("star-add", 60010),
            starDelete: Vt("star-delete", 60010),
            starEmpty: Vt("star-empty", 60010),
            comment: Vt("comment", 60011),
            commentAdd: Vt("comment-add", 60011),
            alert: Vt("alert", 60012),
            warning: Vt("warning", 60012),
            search: Vt("search", 60013),
            searchSave: Vt("search-save", 60013),
            logOut: Vt("log-out", 60014),
            signOut: Vt("sign-out", 60014),
            logIn: Vt("log-in", 60015),
            signIn: Vt("sign-in", 60015),
            eye: Vt("eye", 60016),
            eyeUnwatch: Vt("eye-unwatch", 60016),
            eyeWatch: Vt("eye-watch", 60016),
            circleFilled: Vt("circle-filled", 60017),
            primitiveDot: Vt("primitive-dot", 60017),
            closeDirty: Vt("close-dirty", 60017),
            debugBreakpoint: Vt("debug-breakpoint", 60017),
            debugBreakpointDisabled: Vt("debug-breakpoint-disabled", 60017),
            debugHint: Vt("debug-hint", 60017),
            terminalDecorationSuccess: Vt("terminal-decoration-success", 60017),
            primitiveSquare: Vt("primitive-square", 60018),
            edit: Vt("edit", 60019),
            pencil: Vt("pencil", 60019),
            info: Vt("info", 60020),
            issueOpened: Vt("issue-opened", 60020),
            gistPrivate: Vt("gist-private", 60021),
            gitForkPrivate: Vt("git-fork-private", 60021),
            lock: Vt("lock", 60021),
            mirrorPrivate: Vt("mirror-private", 60021),
            close: Vt("close", 60022),
            removeClose: Vt("remove-close", 60022),
            x: Vt("x", 60022),
            repoSync: Vt("repo-sync", 60023),
            sync: Vt("sync", 60023),
            clone: Vt("clone", 60024),
            desktopDownload: Vt("desktop-download", 60024),
            beaker: Vt("beaker", 60025),
            microscope: Vt("microscope", 60025),
            vm: Vt("vm", 60026),
            deviceDesktop: Vt("device-desktop", 60026),
            file: Vt("file", 60027),
            more: Vt("more", 60028),
            ellipsis: Vt("ellipsis", 60028),
            kebabHorizontal: Vt("kebab-horizontal", 60028),
            mailReply: Vt("mail-reply", 60029),
            reply: Vt("reply", 60029),
            organization: Vt("organization", 60030),
            organizationFilled: Vt("organization-filled", 60030),
            organizationOutline: Vt("organization-outline", 60030),
            newFile: Vt("new-file", 60031),
            fileAdd: Vt("file-add", 60031),
            newFolder: Vt("new-folder", 60032),
            fileDirectoryCreate: Vt("file-directory-create", 60032),
            trash: Vt("trash", 60033),
            trashcan: Vt("trashcan", 60033),
            history: Vt("history", 60034),
            clock: Vt("clock", 60034),
            folder: Vt("folder", 60035),
            fileDirectory: Vt("file-directory", 60035),
            symbolFolder: Vt("symbol-folder", 60035),
            logoGithub: Vt("logo-github", 60036),
            markGithub: Vt("mark-github", 60036),
            github: Vt("github", 60036),
            terminal: Vt("terminal", 60037),
            console: Vt("console", 60037),
            repl: Vt("repl", 60037),
            zap: Vt("zap", 60038),
            symbolEvent: Vt("symbol-event", 60038),
            error: Vt("error", 60039),
            stop: Vt("stop", 60039),
            variable: Vt("variable", 60040),
            symbolVariable: Vt("symbol-variable", 60040),
            array: Vt("array", 60042),
            symbolArray: Vt("symbol-array", 60042),
            symbolModule: Vt("symbol-module", 60043),
            symbolPackage: Vt("symbol-package", 60043),
            symbolNamespace: Vt("symbol-namespace", 60043),
            symbolObject: Vt("symbol-object", 60043),
            symbolMethod: Vt("symbol-method", 60044),
            symbolFunction: Vt("symbol-function", 60044),
            symbolConstructor: Vt("symbol-constructor", 60044),
            symbolBoolean: Vt("symbol-boolean", 60047),
            symbolNull: Vt("symbol-null", 60047),
            symbolNumeric: Vt("symbol-numeric", 60048),
            symbolNumber: Vt("symbol-number", 60048),
            symbolStructure: Vt("symbol-structure", 60049),
            symbolStruct: Vt("symbol-struct", 60049),
            symbolParameter: Vt("symbol-parameter", 60050),
            symbolTypeParameter: Vt("symbol-type-parameter", 60050),
            symbolKey: Vt("symbol-key", 60051),
            symbolText: Vt("symbol-text", 60051),
            symbolReference: Vt("symbol-reference", 60052),
            goToFile: Vt("go-to-file", 60052),
            symbolEnum: Vt("symbol-enum", 60053),
            symbolValue: Vt("symbol-value", 60053),
            symbolRuler: Vt("symbol-ruler", 60054),
            symbolUnit: Vt("symbol-unit", 60054),
            activateBreakpoints: Vt("activate-breakpoints", 60055),
            archive: Vt("archive", 60056),
            arrowBoth: Vt("arrow-both", 60057),
            arrowDown: Vt("arrow-down", 60058),
            arrowLeft: Vt("arrow-left", 60059),
            arrowRight: Vt("arrow-right", 60060),
            arrowSmallDown: Vt("arrow-small-down", 60061),
            arrowSmallLeft: Vt("arrow-small-left", 60062),
            arrowSmallRight: Vt("arrow-small-right", 60063),
            arrowSmallUp: Vt("arrow-small-up", 60064),
            arrowUp: Vt("arrow-up", 60065),
            bell: Vt("bell", 60066),
            bold: Vt("bold", 60067),
            book: Vt("book", 60068),
            bookmark: Vt("bookmark", 60069),
            debugBreakpointConditionalUnverified: Vt(
                "debug-breakpoint-conditional-unverified",
                60070,
            ),
            debugBreakpointConditional: Vt(
                "debug-breakpoint-conditional",
                60071,
            ),
            debugBreakpointConditionalDisabled: Vt(
                "debug-breakpoint-conditional-disabled",
                60071,
            ),
            debugBreakpointDataUnverified: Vt(
                "debug-breakpoint-data-unverified",
                60072,
            ),
            debugBreakpointData: Vt("debug-breakpoint-data", 60073),
            debugBreakpointDataDisabled: Vt(
                "debug-breakpoint-data-disabled",
                60073,
            ),
            debugBreakpointLogUnverified: Vt(
                "debug-breakpoint-log-unverified",
                60074,
            ),
            debugBreakpointLog: Vt("debug-breakpoint-log", 60075),
            debugBreakpointLogDisabled: Vt(
                "debug-breakpoint-log-disabled",
                60075,
            ),
            briefcase: Vt("briefcase", 60076),
            broadcast: Vt("broadcast", 60077),
            browser: Vt("browser", 60078),
            bug: Vt("bug", 60079),
            calendar: Vt("calendar", 60080),
            caseSensitive: Vt("case-sensitive", 60081),
            check: Vt("check", 60082),
            checklist: Vt("checklist", 60083),
            chevronDown: Vt("chevron-down", 60084),
            chevronLeft: Vt("chevron-left", 60085),
            chevronRight: Vt("chevron-right", 60086),
            chevronUp: Vt("chevron-up", 60087),
            chromeClose: Vt("chrome-close", 60088),
            chromeMaximize: Vt("chrome-maximize", 60089),
            chromeMinimize: Vt("chrome-minimize", 60090),
            chromeRestore: Vt("chrome-restore", 60091),
            circleOutline: Vt("circle-outline", 60092),
            circle: Vt("circle", 60092),
            debugBreakpointUnverified: Vt("debug-breakpoint-unverified", 60092),
            terminalDecorationIncomplete: Vt(
                "terminal-decoration-incomplete",
                60092,
            ),
            circleSlash: Vt("circle-slash", 60093),
            circuitBoard: Vt("circuit-board", 60094),
            clearAll: Vt("clear-all", 60095),
            clippy: Vt("clippy", 60096),
            closeAll: Vt("close-all", 60097),
            cloudDownload: Vt("cloud-download", 60098),
            cloudUpload: Vt("cloud-upload", 60099),
            code: Vt("code", 60100),
            collapseAll: Vt("collapse-all", 60101),
            colorMode: Vt("color-mode", 60102),
            commentDiscussion: Vt("comment-discussion", 60103),
            creditCard: Vt("credit-card", 60105),
            dash: Vt("dash", 60108),
            dashboard: Vt("dashboard", 60109),
            database: Vt("database", 60110),
            debugContinue: Vt("debug-continue", 60111),
            debugDisconnect: Vt("debug-disconnect", 60112),
            debugPause: Vt("debug-pause", 60113),
            debugRestart: Vt("debug-restart", 60114),
            debugStart: Vt("debug-start", 60115),
            debugStepInto: Vt("debug-step-into", 60116),
            debugStepOut: Vt("debug-step-out", 60117),
            debugStepOver: Vt("debug-step-over", 60118),
            debugStop: Vt("debug-stop", 60119),
            debug: Vt("debug", 60120),
            deviceCameraVideo: Vt("device-camera-video", 60121),
            deviceCamera: Vt("device-camera", 60122),
            deviceMobile: Vt("device-mobile", 60123),
            diffAdded: Vt("diff-added", 60124),
            diffIgnored: Vt("diff-ignored", 60125),
            diffModified: Vt("diff-modified", 60126),
            diffRemoved: Vt("diff-removed", 60127),
            diffRenamed: Vt("diff-renamed", 60128),
            diff: Vt("diff", 60129),
            diffSidebyside: Vt("diff-sidebyside", 60129),
            discard: Vt("discard", 60130),
            editorLayout: Vt("editor-layout", 60131),
            emptyWindow: Vt("empty-window", 60132),
            exclude: Vt("exclude", 60133),
            extensions: Vt("extensions", 60134),
            eyeClosed: Vt("eye-closed", 60135),
            fileBinary: Vt("file-binary", 60136),
            fileCode: Vt("file-code", 60137),
            fileMedia: Vt("file-media", 60138),
            filePdf: Vt("file-pdf", 60139),
            fileSubmodule: Vt("file-submodule", 60140),
            fileSymlinkDirectory: Vt("file-symlink-directory", 60141),
            fileSymlinkFile: Vt("file-symlink-file", 60142),
            fileZip: Vt("file-zip", 60143),
            files: Vt("files", 60144),
            filter: Vt("filter", 60145),
            flame: Vt("flame", 60146),
            foldDown: Vt("fold-down", 60147),
            foldUp: Vt("fold-up", 60148),
            fold: Vt("fold", 60149),
            folderActive: Vt("folder-active", 60150),
            folderOpened: Vt("folder-opened", 60151),
            gear: Vt("gear", 60152),
            gift: Vt("gift", 60153),
            gistSecret: Vt("gist-secret", 60154),
            gist: Vt("gist", 60155),
            gitCommit: Vt("git-commit", 60156),
            gitCompare: Vt("git-compare", 60157),
            compareChanges: Vt("compare-changes", 60157),
            gitMerge: Vt("git-merge", 60158),
            githubAction: Vt("github-action", 60159),
            githubAlt: Vt("github-alt", 60160),
            globe: Vt("globe", 60161),
            grabber: Vt("grabber", 60162),
            graph: Vt("graph", 60163),
            gripper: Vt("gripper", 60164),
            heart: Vt("heart", 60165),
            home: Vt("home", 60166),
            horizontalRule: Vt("horizontal-rule", 60167),
            hubot: Vt("hubot", 60168),
            inbox: Vt("inbox", 60169),
            issueReopened: Vt("issue-reopened", 60171),
            issues: Vt("issues", 60172),
            italic: Vt("italic", 60173),
            jersey: Vt("jersey", 60174),
            json: Vt("json", 60175),
            kebabVertical: Vt("kebab-vertical", 60176),
            key: Vt("key", 60177),
            law: Vt("law", 60178),
            lightbulbAutofix: Vt("lightbulb-autofix", 60179),
            linkExternal: Vt("link-external", 60180),
            link: Vt("link", 60181),
            listOrdered: Vt("list-ordered", 60182),
            listUnordered: Vt("list-unordered", 60183),
            liveShare: Vt("live-share", 60184),
            loading: Vt("loading", 60185),
            location: Vt("location", 60186),
            mailRead: Vt("mail-read", 60187),
            mail: Vt("mail", 60188),
            markdown: Vt("markdown", 60189),
            megaphone: Vt("megaphone", 60190),
            mention: Vt("mention", 60191),
            milestone: Vt("milestone", 60192),
            gitPullRequestMilestone: Vt("git-pull-request-milestone", 60192),
            mortarBoard: Vt("mortar-board", 60193),
            move: Vt("move", 60194),
            multipleWindows: Vt("multiple-windows", 60195),
            mute: Vt("mute", 60196),
            noNewline: Vt("no-newline", 60197),
            note: Vt("note", 60198),
            octoface: Vt("octoface", 60199),
            openPreview: Vt("open-preview", 60200),
            package: Vt("package", 60201),
            paintcan: Vt("paintcan", 60202),
            pin: Vt("pin", 60203),
            play: Vt("play", 60204),
            run: Vt("run", 60204),
            plug: Vt("plug", 60205),
            preserveCase: Vt("preserve-case", 60206),
            preview: Vt("preview", 60207),
            project: Vt("project", 60208),
            pulse: Vt("pulse", 60209),
            question: Vt("question", 60210),
            quote: Vt("quote", 60211),
            radioTower: Vt("radio-tower", 60212),
            reactions: Vt("reactions", 60213),
            references: Vt("references", 60214),
            refresh: Vt("refresh", 60215),
            regex: Vt("regex", 60216),
            remoteExplorer: Vt("remote-explorer", 60217),
            remote: Vt("remote", 60218),
            remove: Vt("remove", 60219),
            replaceAll: Vt("replace-all", 60220),
            replace: Vt("replace", 60221),
            repoClone: Vt("repo-clone", 60222),
            repoForcePush: Vt("repo-force-push", 60223),
            repoPull: Vt("repo-pull", 60224),
            repoPush: Vt("repo-push", 60225),
            report: Vt("report", 60226),
            requestChanges: Vt("request-changes", 60227),
            rocket: Vt("rocket", 60228),
            rootFolderOpened: Vt("root-folder-opened", 60229),
            rootFolder: Vt("root-folder", 60230),
            rss: Vt("rss", 60231),
            ruby: Vt("ruby", 60232),
            saveAll: Vt("save-all", 60233),
            saveAs: Vt("save-as", 60234),
            save: Vt("save", 60235),
            screenFull: Vt("screen-full", 60236),
            screenNormal: Vt("screen-normal", 60237),
            searchStop: Vt("search-stop", 60238),
            server: Vt("server", 60240),
            settingsGear: Vt("settings-gear", 60241),
            settings: Vt("settings", 60242),
            shield: Vt("shield", 60243),
            smiley: Vt("smiley", 60244),
            sortPrecedence: Vt("sort-precedence", 60245),
            splitHorizontal: Vt("split-horizontal", 60246),
            splitVertical: Vt("split-vertical", 60247),
            squirrel: Vt("squirrel", 60248),
            starFull: Vt("star-full", 60249),
            starHalf: Vt("star-half", 60250),
            symbolClass: Vt("symbol-class", 60251),
            symbolColor: Vt("symbol-color", 60252),
            symbolConstant: Vt("symbol-constant", 60253),
            symbolEnumMember: Vt("symbol-enum-member", 60254),
            symbolField: Vt("symbol-field", 60255),
            symbolFile: Vt("symbol-file", 60256),
            symbolInterface: Vt("symbol-interface", 60257),
            symbolKeyword: Vt("symbol-keyword", 60258),
            symbolMisc: Vt("symbol-misc", 60259),
            symbolOperator: Vt("symbol-operator", 60260),
            symbolProperty: Vt("symbol-property", 60261),
            wrench: Vt("wrench", 60261),
            wrenchSubaction: Vt("wrench-subaction", 60261),
            symbolSnippet: Vt("symbol-snippet", 60262),
            tasklist: Vt("tasklist", 60263),
            telescope: Vt("telescope", 60264),
            textSize: Vt("text-size", 60265),
            threeBars: Vt("three-bars", 60266),
            thumbsdown: Vt("thumbsdown", 60267),
            thumbsup: Vt("thumbsup", 60268),
            tools: Vt("tools", 60269),
            triangleDown: Vt("triangle-down", 60270),
            triangleLeft: Vt("triangle-left", 60271),
            triangleRight: Vt("triangle-right", 60272),
            triangleUp: Vt("triangle-up", 60273),
            twitter: Vt("twitter", 60274),
            unfold: Vt("unfold", 60275),
            unlock: Vt("unlock", 60276),
            unmute: Vt("unmute", 60277),
            unverified: Vt("unverified", 60278),
            verified: Vt("verified", 60279),
            versions: Vt("versions", 60280),
            vmActive: Vt("vm-active", 60281),
            vmOutline: Vt("vm-outline", 60282),
            vmRunning: Vt("vm-running", 60283),
            watch: Vt("watch", 60284),
            whitespace: Vt("whitespace", 60285),
            wholeWord: Vt("whole-word", 60286),
            window: Vt("window", 60287),
            wordWrap: Vt("word-wrap", 60288),
            zoomIn: Vt("zoom-in", 60289),
            zoomOut: Vt("zoom-out", 60290),
            listFilter: Vt("list-filter", 60291),
            listFlat: Vt("list-flat", 60292),
            listSelection: Vt("list-selection", 60293),
            selection: Vt("selection", 60293),
            listTree: Vt("list-tree", 60294),
            debugBreakpointFunctionUnverified: Vt(
                "debug-breakpoint-function-unverified",
                60295,
            ),
            debugBreakpointFunction: Vt("debug-breakpoint-function", 60296),
            debugBreakpointFunctionDisabled: Vt(
                "debug-breakpoint-function-disabled",
                60296,
            ),
            debugStackframeActive: Vt("debug-stackframe-active", 60297),
            circleSmallFilled: Vt("circle-small-filled", 60298),
            debugStackframeDot: Vt("debug-stackframe-dot", 60298),
            terminalDecorationMark: Vt("terminal-decoration-mark", 60298),
            debugStackframe: Vt("debug-stackframe", 60299),
            debugStackframeFocused: Vt("debug-stackframe-focused", 60299),
            debugBreakpointUnsupported: Vt(
                "debug-breakpoint-unsupported",
                60300,
            ),
            symbolString: Vt("symbol-string", 60301),
            debugReverseContinue: Vt("debug-reverse-continue", 60302),
            debugStepBack: Vt("debug-step-back", 60303),
            debugRestartFrame: Vt("debug-restart-frame", 60304),
            debugAlt: Vt("debug-alt", 60305),
            callIncoming: Vt("call-incoming", 60306),
            callOutgoing: Vt("call-outgoing", 60307),
            menu: Vt("menu", 60308),
            expandAll: Vt("expand-all", 60309),
            feedback: Vt("feedback", 60310),
            gitPullRequestReviewer: Vt("git-pull-request-reviewer", 60310),
            groupByRefType: Vt("group-by-ref-type", 60311),
            ungroupByRefType: Vt("ungroup-by-ref-type", 60312),
            account: Vt("account", 60313),
            gitPullRequestAssignee: Vt("git-pull-request-assignee", 60313),
            bellDot: Vt("bell-dot", 60314),
            debugConsole: Vt("debug-console", 60315),
            library: Vt("library", 60316),
            output: Vt("output", 60317),
            runAll: Vt("run-all", 60318),
            syncIgnored: Vt("sync-ignored", 60319),
            pinned: Vt("pinned", 60320),
            githubInverted: Vt("github-inverted", 60321),
            serverProcess: Vt("server-process", 60322),
            serverEnvironment: Vt("server-environment", 60323),
            pass: Vt("pass", 60324),
            issueClosed: Vt("issue-closed", 60324),
            stopCircle: Vt("stop-circle", 60325),
            playCircle: Vt("play-circle", 60326),
            record: Vt("record", 60327),
            debugAltSmall: Vt("debug-alt-small", 60328),
            vmConnect: Vt("vm-connect", 60329),
            cloud: Vt("cloud", 60330),
            merge: Vt("merge", 60331),
            export: Vt("export", 60332),
            graphLeft: Vt("graph-left", 60333),
            magnet: Vt("magnet", 60334),
            notebook: Vt("notebook", 60335),
            redo: Vt("redo", 60336),
            checkAll: Vt("check-all", 60337),
            pinnedDirty: Vt("pinned-dirty", 60338),
            passFilled: Vt("pass-filled", 60339),
            circleLargeFilled: Vt("circle-large-filled", 60340),
            circleLarge: Vt("circle-large", 60341),
            circleLargeOutline: Vt("circle-large-outline", 60341),
            combine: Vt("combine", 60342),
            gather: Vt("gather", 60342),
            table: Vt("table", 60343),
            variableGroup: Vt("variable-group", 60344),
            typeHierarchy: Vt("type-hierarchy", 60345),
            typeHierarchySub: Vt("type-hierarchy-sub", 60346),
            typeHierarchySuper: Vt("type-hierarchy-super", 60347),
            gitPullRequestCreate: Vt("git-pull-request-create", 60348),
            runAbove: Vt("run-above", 60349),
            runBelow: Vt("run-below", 60350),
            notebookTemplate: Vt("notebook-template", 60351),
            debugRerun: Vt("debug-rerun", 60352),
            workspaceTrusted: Vt("workspace-trusted", 60353),
            workspaceUntrusted: Vt("workspace-untrusted", 60354),
            workspaceUnknown: Vt("workspace-unknown", 60355),
            terminalCmd: Vt("terminal-cmd", 60356),
            terminalDebian: Vt("terminal-debian", 60357),
            terminalLinux: Vt("terminal-linux", 60358),
            terminalPowershell: Vt("terminal-powershell", 60359),
            terminalTmux: Vt("terminal-tmux", 60360),
            terminalUbuntu: Vt("terminal-ubuntu", 60361),
            terminalBash: Vt("terminal-bash", 60362),
            arrowSwap: Vt("arrow-swap", 60363),
            copy: Vt("copy", 60364),
            personAdd: Vt("person-add", 60365),
            filterFilled: Vt("filter-filled", 60366),
            wand: Vt("wand", 60367),
            debugLineByLine: Vt("debug-line-by-line", 60368),
            inspect: Vt("inspect", 60369),
            layers: Vt("layers", 60370),
            layersDot: Vt("layers-dot", 60371),
            layersActive: Vt("layers-active", 60372),
            compass: Vt("compass", 60373),
            compassDot: Vt("compass-dot", 60374),
            compassActive: Vt("compass-active", 60375),
            azure: Vt("azure", 60376),
            issueDraft: Vt("issue-draft", 60377),
            gitPullRequestClosed: Vt("git-pull-request-closed", 60378),
            gitPullRequestDraft: Vt("git-pull-request-draft", 60379),
            debugAll: Vt("debug-all", 60380),
            debugCoverage: Vt("debug-coverage", 60381),
            runErrors: Vt("run-errors", 60382),
            folderLibrary: Vt("folder-library", 60383),
            debugContinueSmall: Vt("debug-continue-small", 60384),
            beakerStop: Vt("beaker-stop", 60385),
            graphLine: Vt("graph-line", 60386),
            graphScatter: Vt("graph-scatter", 60387),
            pieChart: Vt("pie-chart", 60388),
            bracket: Vt("bracket", 60175),
            bracketDot: Vt("bracket-dot", 60389),
            bracketError: Vt("bracket-error", 60390),
            lockSmall: Vt("lock-small", 60391),
            azureDevops: Vt("azure-devops", 60392),
            verifiedFilled: Vt("verified-filled", 60393),
            newline: Vt("newline", 60394),
            layout: Vt("layout", 60395),
            layoutActivitybarLeft: Vt("layout-activitybar-left", 60396),
            layoutActivitybarRight: Vt("layout-activitybar-right", 60397),
            layoutPanelLeft: Vt("layout-panel-left", 60398),
            layoutPanelCenter: Vt("layout-panel-center", 60399),
            layoutPanelJustify: Vt("layout-panel-justify", 60400),
            layoutPanelRight: Vt("layout-panel-right", 60401),
            layoutPanel: Vt("layout-panel", 60402),
            layoutSidebarLeft: Vt("layout-sidebar-left", 60403),
            layoutSidebarRight: Vt("layout-sidebar-right", 60404),
            layoutStatusbar: Vt("layout-statusbar", 60405),
            layoutMenubar: Vt("layout-menubar", 60406),
            layoutCentered: Vt("layout-centered", 60407),
            target: Vt("target", 60408),
            indent: Vt("indent", 60409),
            recordSmall: Vt("record-small", 60410),
            errorSmall: Vt("error-small", 60411),
            terminalDecorationError: Vt("terminal-decoration-error", 60411),
            arrowCircleDown: Vt("arrow-circle-down", 60412),
            arrowCircleLeft: Vt("arrow-circle-left", 60413),
            arrowCircleRight: Vt("arrow-circle-right", 60414),
            arrowCircleUp: Vt("arrow-circle-up", 60415),
            layoutSidebarRightOff: Vt("layout-sidebar-right-off", 60416),
            layoutPanelOff: Vt("layout-panel-off", 60417),
            layoutSidebarLeftOff: Vt("layout-sidebar-left-off", 60418),
            blank: Vt("blank", 60419),
            heartFilled: Vt("heart-filled", 60420),
            map: Vt("map", 60421),
            mapHorizontal: Vt("map-horizontal", 60421),
            foldHorizontal: Vt("fold-horizontal", 60421),
            mapFilled: Vt("map-filled", 60422),
            mapHorizontalFilled: Vt("map-horizontal-filled", 60422),
            foldHorizontalFilled: Vt("fold-horizontal-filled", 60422),
            circleSmall: Vt("circle-small", 60423),
            bellSlash: Vt("bell-slash", 60424),
            bellSlashDot: Vt("bell-slash-dot", 60425),
            commentUnresolved: Vt("comment-unresolved", 60426),
            gitPullRequestGoToChanges: Vt(
                "git-pull-request-go-to-changes",
                60427,
            ),
            gitPullRequestNewChanges: Vt("git-pull-request-new-changes", 60428),
            searchFuzzy: Vt("search-fuzzy", 60429),
            commentDraft: Vt("comment-draft", 60430),
            send: Vt("send", 60431),
            sparkle: Vt("sparkle", 60432),
            insert: Vt("insert", 60433),
            mic: Vt("mic", 60434),
            thumbsdownFilled: Vt("thumbsdown-filled", 60435),
            thumbsupFilled: Vt("thumbsup-filled", 60436),
            coffee: Vt("coffee", 60437),
            snake: Vt("snake", 60438),
            game: Vt("game", 60439),
            vr: Vt("vr", 60440),
            chip: Vt("chip", 60441),
            piano: Vt("piano", 60442),
            music: Vt("music", 60443),
            micFilled: Vt("mic-filled", 60444),
            repoFetch: Vt("repo-fetch", 60445),
            copilot: Vt("copilot", 60446),
            lightbulbSparkle: Vt("lightbulb-sparkle", 60447),
            robot: Vt("robot", 60448),
            sparkleFilled: Vt("sparkle-filled", 60449),
            diffSingle: Vt("diff-single", 60450),
            diffMultiple: Vt("diff-multiple", 60451),
            surroundWith: Vt("surround-with", 60452),
            share: Vt("share", 60453),
            gitStash: Vt("git-stash", 60454),
            gitStashApply: Vt("git-stash-apply", 60455),
            gitStashPop: Vt("git-stash-pop", 60456),
            vscode: Vt("vscode", 60457),
            vscodeInsiders: Vt("vscode-insiders", 60458),
            codeOss: Vt("code-oss", 60459),
            runCoverage: Vt("run-coverage", 60460),
            runAllCoverage: Vt("run-all-coverage", 60461),
            coverage: Vt("coverage", 60462),
            githubProject: Vt("github-project", 60463),
            mapVertical: Vt("map-vertical", 60464),
            foldVertical: Vt("fold-vertical", 60464),
            mapVerticalFilled: Vt("map-vertical-filled", 60465),
            foldVerticalFilled: Vt("fold-vertical-filled", 60465),
            goToSearch: Vt("go-to-search", 60466),
            percentage: Vt("percentage", 60467),
            sortPercentage: Vt("sort-percentage", 60467),
            attach: Vt("attach", 60468),
            goToEditingSession: Vt("go-to-editing-session", 60469),
            editSession: Vt("edit-session", 60470),
            codeReview: Vt("code-review", 60471),
            copilotWarning: Vt("copilot-warning", 60472),
            python: Vt("python", 60473),
            copilotLarge: Vt("copilot-large", 60474),
            copilotWarningLarge: Vt("copilot-warning-large", 60475),
            keyboardTab: Vt("keyboard-tab", 60476),
            copilotBlocked: Vt("copilot-blocked", 60477),
            copilotNotConnected: Vt("copilot-not-connected", 60478),
            flag: Vt("flag", 60479),
            lightbulbEmpty: Vt("lightbulb-empty", 60480),
            symbolMethodArrow: Vt("symbol-method-arrow", 60481),
            copilotUnavailable: Vt("copilot-unavailable", 60482),
            repoPinned: Vt("repo-pinned", 60483),
            keyboardTabAbove: Vt("keyboard-tab-above", 60484),
            keyboardTabBelow: Vt("keyboard-tab-below", 60485),
            gitPullRequestDone: Vt("git-pull-request-done", 60486),
            mcp: Vt("mcp", 60487),
            extensionsLarge: Vt("extensions-large", 60488),
            layoutPanelDock: Vt("layout-panel-dock", 60489),
            layoutSidebarLeftDock: Vt("layout-sidebar-left-dock", 60490),
            layoutSidebarRightDock: Vt("layout-sidebar-right-dock", 60491),
            copilotInProgress: Vt("copilot-in-progress", 60492),
            copilotError: Vt("copilot-error", 60493),
            copilotSuccess: Vt("copilot-success", 60494),
            chatSparkle: Vt("chat-sparkle", 60495),
            searchSparkle: Vt("search-sparkle", 60496),
            editSparkle: Vt("edit-sparkle", 60497),
            copilotSnooze: Vt("copilot-snooze", 60498),
            sendToRemoteAgent: Vt("send-to-remote-agent", 60499),
            commentDiscussionSparkle: Vt("comment-discussion-sparkle", 60500),
            chatSparkleWarning: Vt("chat-sparkle-warning", 60501),
            chatSparkleError: Vt("chat-sparkle-error", 60502),
            collection: Vt("collection", 60503),
            newCollection: Vt("new-collection", 60504),
            thinking: Vt("thinking", 60505),
            build: Vt("build", 60506),
            commentDiscussionQuote: Vt("comment-discussion-quote", 60507),
            cursor: Vt("cursor", 60508),
            eraser: Vt("eraser", 60509),
            fileText: Vt("file-text", 60510),
            gitLens: Vt("git-lens", 60511),
            quotes: Vt("quotes", 60512),
            rename: Vt("rename", 60513),
            runWithDeps: Vt("run-with-deps", 60514),
            debugConnected: Vt("debug-connected", 60515),
            strikethrough: Vt("strikethrough", 60516),
            openInProduct: Vt("open-in-product", 60517),
            indexZero: Vt("index-zero", 60518),
            agent: Vt("agent", 60519),
            editCode: Vt("edit-code", 60520),
            repoSelected: Vt("repo-selected", 60521),
            skip: Vt("skip", 60522),
            mergeInto: Vt("merge-into", 60523),
            gitBranchChanges: Vt("git-branch-changes", 60524),
            gitBranchStagedChanges: Vt("git-branch-staged-changes", 60525),
            gitBranchConflicts: Vt("git-branch-conflicts", 60526),
            gitBranch: Vt("git-branch", 60527),
            gitBranchCreate: Vt("git-branch-create", 60527),
            gitBranchDelete: Vt("git-branch-delete", 60527),
            searchLarge: Vt("search-large", 60528),
            terminalGitBash: Vt("terminal-git-bash", 60529),
        },
        ...{
            dialogError: Vt("dialog-error", "error"),
            dialogWarning: Vt("dialog-warning", "warning"),
            dialogInfo: Vt("dialog-info", "info"),
            dialogClose: Vt("dialog-close", "close"),
            treeItemExpanded: Vt("tree-item-expanded", "chevron-down"),
            treeFilterOnTypeOn: Vt("tree-filter-on-type-on", "list-filter"),
            treeFilterOnTypeOff: Vt(
                "tree-filter-on-type-off",
                "list-selection",
            ),
            treeFilterClear: Vt("tree-filter-clear", "close"),
            treeItemLoading: Vt("tree-item-loading", "loading"),
            menuSelection: Vt("menu-selection", "check"),
            menuSubmenu: Vt("menu-submenu", "chevron-right"),
            menuBarMore: Vt("menubar-more", "more"),
            scrollbarButtonLeft: Vt("scrollbar-button-left", "triangle-left"),
            scrollbarButtonRight: Vt(
                "scrollbar-button-right",
                "triangle-right",
            ),
            scrollbarButtonUp: Vt("scrollbar-button-up", "triangle-up"),
            scrollbarButtonDown: Vt("scrollbar-button-down", "triangle-down"),
            toolBarMore: Vt("toolbar-more", "more"),
            quickInputBack: Vt("quick-input-back", "arrow-left"),
            dropDownButton: Vt("drop-down-button", 60084),
            symbolCustomColor: Vt("symbol-customcolor", 60252),
            exportIcon: Vt("export", 60332),
            workspaceUnspecified: Vt("workspace-unspecified", 60355),
            newLine: Vt("newline", 60394),
            thumbsDownFilled: Vt("thumbsdown-filled", 60435),
            thumbsUpFilled: Vt("thumbsup-filled", 60436),
            gitFetch: Vt("git-fetch", 60445),
            lightbulbSparkleAutofix: Vt("lightbulb-sparkle-autofix", 60447),
            debugBreakpointPending: Vt("debug-breakpoint-pending", 60377),
        },
    };
    class qt extends p {
        get isResolved() {
    ...
    var $t, Bt, Ut, jt, Wt, zt, Ht, Gt, Jt;
    (!(function (e) {
        ((e[(e.Increase = 0)] = "Increase"),
            (e[(e.Decrease = 1)] = "Decrease"));
    })($t || ($t = {})),
        (function (e) {
            const t = new Map();
            (t.set(0, Dt.symbolMethod),
                t.set(1, Dt.symbolFunction),
                t.set(2, Dt.symbolConstructor),
                t.set(3, Dt.symbolField),
                t.set(4, Dt.symbolVariable),
                t.set(5, Dt.symbolClass),
                t.set(6, Dt.symbolStruct),
                t.set(7, Dt.symbolInterface),
                t.set(8, Dt.symbolModule),
                t.set(9, Dt.symbolProperty),
                t.set(10, Dt.symbolEvent),
                t.set(11, Dt.symbolOperator),
                t.set(12, Dt.symbolUnit),
                t.set(13, Dt.symbolValue),
                t.set(15, Dt.symbolEnum),
                t.set(14, Dt.symbolConstant),
                t.set(15, Dt.symbolEnum),
                t.set(16, Dt.symbolEnumMember),
                t.set(17, Dt.symbolKeyword),
                t.set(28, Dt.symbolSnippet),
                t.set(18, Dt.symbolText),
                t.set(19, Dt.symbolColor),
                t.set(20, Dt.symbolFile),
                t.set(21, Dt.symbolReference),
                t.set(22, Dt.symbolCustomColor),
                t.set(23, Dt.symbolFolder),
                t.set(24, Dt.symbolTypeParameter),
                t.set(25, Dt.account),
                t.set(26, Dt.issues),
                t.set(27, Dt.tools),
                (e.toIcon = function (e) {
                    let n = t.get(e);
                    return (n || (n = Dt.symbolProperty), n);
                }),
                (e.toLabel = function (e) {
                    switch (e) {
                        case 0:
                            return O(728, "Method");
                        case 1:
                            return O(729, "Function");
                        case 2:
                            return O(730, "Constructor");
                        case 3:
                            return O(731, "Field");
                        case 4:
                            return O(732, "Variable");
                        case 5:
                            return O(733, "Class");
                        case 6:
                            return O(734, "Struct");
                        case 7:
                            return O(735, "Interface");
                        case 8:
                            return O(736, "Module");
                        case 9:
                            return O(737, "Property");
                        case 10:
                            return O(738, "Event");
                        case 11:
                            return O(739, "Operator");
                        case 12:
                            return O(740, "Unit");
                        case 13:
                            return O(741, "Value");
                        case 14:
                            return O(742, "Constant");
                        case 15:
                            return O(743, "Enum");
                        case 16:
                            return O(744, "Enum Member");
                        case 17:
                            return O(745, "Keyword");
                        case 18:
                            return O(746, "Text");
                        case 19:
                            return O(747, "Color");
                        case 20:
                            return O(748, "File");
                        case 21:
                            return O(749, "Reference");
                        case 22:
                            return O(750, "Custom Color");
                        case 23:
                            return O(751, "Folder");
                        case 24:
                            return O(752, "Type Parameter");
                        case 25:
                            return O(753, "User");
                        case 26:
                            return O(754, "Issue");
        ...
        O(779, "string"),
        O(780, "struct"),
        O(781, "type parameter"),
        O(782, "variable"),
        (function (e) {
            const t = new Map();
            (t.set(0, Dt.symbolFile),
                t.set(1, Dt.symbolModule),
                t.set(2, Dt.symbolNamespace),
                t.set(3, Dt.symbolPackage),
                t.set(4, Dt.symbolClass),
                t.set(5, Dt.symbolMethod),
                t.set(6, Dt.symbolProperty),
                t.set(7, Dt.symbolField),
                t.set(8, Dt.symbolConstructor),
                t.set(9, Dt.symbolEnum),
                t.set(10, Dt.symbolInterface),
                t.set(11, Dt.symbolFunction),
                t.set(12, Dt.symbolVariable),
                t.set(13, Dt.symbolConstant),
                t.set(14, Dt.symbolString),
                t.set(15, Dt.symbolNumber),
                t.set(16, Dt.symbolBoolean),
                t.set(17, Dt.symbolArray),
                t.set(18, Dt.symbolObject),
                t.set(19, Dt.symbolKey),
                t.set(20, Dt.symbolNull),
                t.set(21, Dt.symbolEnumMember),
                t.set(22, Dt.symbolStruct),
                t.set(23, Dt.symbolEvent),
                t.set(24, Dt.symbolOperator),
                t.set(25, Dt.symbolTypeParameter),
                (e.toIcon = function (e) {
                    let n = t.get(e);
                    return (n || (n = Dt.symbolProperty), n);
                }));
    ...
    (!(function (e) {
            ...
            registerFactory(e, t) {
                ...
                return (
                    ...
                    m(() => {
                        ...
                        t &&
                            t === n &&
                            (this._factories.delete(e), t.dispose());
                    })
                );
            }
            async getOrCreate(e) {
        ...
        (function (e) {
            ((e[(e.acceptSuggestionOnCommitCharacter = 0)] =
                ...
                (e[(e.allowVariableLineHeights = 5)] =
                    "allowVariableLineHeights"),
                (e[(e.allowVariableFonts = 6)] = "allowVariableFonts"),
                (e[(e.allowVariableFontsInAccessibilityMode = 7)] =
                ...
                (e[(e.screenReaderAnnounceInlineSuggestion = 12)] =
                ...
                (e[(e.emptySelectionClipboard = 45)] =
                    "emptySelectionClipboard"),
                (e[(e.experimentalGpuAcceleration = 46)] =
                    "experimentalGpuAcceleration"),
                (e[(e.experimentalWhitespaceRendering = 47)] =
                ...
                (e[(e.foldingImportsByDefault = 55)] =
                    "foldingImportsByDefault"),
                (e[(e.foldingMaximumRegions = 56)] = "foldingMaximumRegions"),
                (e[(e.unfoldOnClickAfterEndOfLine = 57)] =
                ...
                (e[(e.hideCursorInOverviewRuler = 68)] =
                ...
                (e[(e.mouseWheelScrollSensitivity = 83)] =
                    "mouseWheelScrollSensitivity"),
                (e[(e.mouseWheelZoom = 84)] = "mouseWheelZoom"),
                (e[(e.multiCursorMergeOverlapping = 85)] =
                ...
                (e[(e.occurrencesHighlightDelay = 91)] =
                ...
                (e[(e.definitionLinkOpensInPeek = 101)] =
                ...
                (e[(e.selectionHighlightMaxLength = 123)] =
                    "selectionHighlightMaxLength"),
                (e[(e.selectionHighlightMultiline = 124)] =
                ...
                (e[(e.wordWrapBreakAfterCharacters = 150)] =
                    "wordWrapBreakAfterCharacters"),
                (e[(e.wordWrapBreakBeforeCharacters = 151)] =
                ...
                (e[(e.wrapOnEscapedLineFeeds = 160)] =
                ...
                (e[(e.defaultColorDecorators = 167)] =
                    "defaultColorDecorators"),
                (e[(e.colorDecoratorsActivatedOn = 168)] =
                    "colorDecoratorsActivatedOn"),
                (e[(e.inlineCompletionsAccessibilityVerbose = 169)] =
                    "inlineCompletionsAccessibilityVerbose"),
                (e[(e.effectiveEditContext = 170)] = "effectiveEditContext"),
                (e[(e.scrollOnMiddleClick = 171)] = "scrollOnMiddleClick"),
                (e[(e.effectiveAllowVariableFonts = 172)] =
    ...
    function ur(e, t, n, r, i) {
        if (((t = ar(t)), i || (i = h.first(lr)), n.length > i.maxLen)) {
            let s = e - i.maxLen / 2;
            return (
                s < 0 ? (s = 0) : (r += s),
                ur(e, t, (n = n.substring(s, e + i.maxLen / 2)), r, i)
            );
        }
        const s = Date.now(),
            o = e - 1 - r;
            ...
            l =
                "allNonBasicAscii" === o
                    ...
                    : new RegExp(
                        "" +
                        ((u = Array.from(o)),
                            `[${((c = u.map((e) => String.fromCodePoint(e)).join("")), c.replace(/[\\\{\}\*\+\?\|\^\$\.\[\]\(\)]/g, "\\$&"))}]`),
                        "g",
                    );
            const h = new sr(null, l),
                d = [];
            let f,
                m = !1,
                g = 0,
            ...
            e: for (let y = r, v = i; y <= v; y++) {
                ...
                do {
                    if (((f = h.next(t)), f)) {
                        ...
                        if (e > 0) {
                            ne(t.charCodeAt(e - 1)) && e--;
                        }
                        if (r + 1 < n) {
                            ne(t.charCodeAt(r - 1)) && r++;
                        }
                        const i = t.substring(e, r);
                        let o = ur(e + 1, or, t, 0);
                        o && o.endColumn <= e + 1 && (o = null);
                        const l = s.shouldHighlightNonBasicASCII(
                            i,
                            o ? o.word : null,
                        );
                        if (0 !== l) {
    ...
    class dr {
        constructor(e) {
            ((this.options = e),
                ...
                (this.ambiguousCharacters = oe.getInstance(
        ...
        getCandidateCodePoints() {
            ...
            if (this.options.invisibleCharacters)
                for (const t of ae.codePoints)
                    fr(String.fromCodePoint(t)) || e.add(t);
    ...
    class vr {
        ...
        filter(e) {
            return new vr((t) => this.iterate((n) => !e(n) || t(n)));
        }
        map(e) {
            return new vr((t) => this.iterate((n) => t(e(n))));
        }
        findLast(e) {
            let t;
        ...
        findLastMaxBy(e) {
            ...
            return (
                this.iterate(
                    (r) => (
                        (n || pr.isGreaterThan(e(r, t))) && ((n = !1), (t = r)),
                        !0
                    ),
                ),
                t
    ...
    class wr {
        ...
        static addRange(e, t) {
            ...
            if (n === r) t.splice(n, 0, e);
                ...
                t.splice(n, r - n, new wr(i, s));
            }
        }
        static tryCreate(e, t) {
            if (!(e > t)) return new wr(e, t);
        }
        static ofLength(e) {
            return new wr(0, e);
        }
        ...
        constructor(e, t) {
            if (((this.start = e), (this.endExclusive = t), e > t))
                throw new o(`Invalid range: ${this.toString()}`);
        }
        get isEmpty() {
            return this.start === this.endExclusive;
        }
        delta(e) {
            return new wr(this.start + e, this.endExclusive + e);
        }
        deltaStart(e) {
            return new wr(this.start + e, this.endExclusive);
        }
        deltaEnd(e) {
            return new wr(this.start, this.endExclusive + e);
        }
        get length() {
        ...
        equals(e) {
            return (
                this.start === e.start && this.endExclusive === e.endExclusive
            );
        }
        contains(e) {
        ...
        clip(e) {
            if (this.isEmpty)
                throw new o(`Invalid clipping range: ${this.toString()}`);
        ...
        joinRightTouching(e) {
            if (this.endExclusive !== e.start)
                throw new o(
                    `Invalid join: ${this.toString()} and ${e.toString()}`,
                );
            return new wr(this.start, e.endExclusive);
        }
    }
    function Cr(e, t) {
        const n = _r(e, t);
    ...
    class Sr {
        ...
        findLastMonotonous(e) {
            ...
            const t = _r(this._array, e, this._findLastMonotonousLastIdx);
            return (
    ...
    class Nr {
        ...
        static fromRange(e) {
            return new Nr(e.startLineNumber, e.endLineNumber);
        }
        static fromRangeInclusive(e) {
            return new Nr(e.startLineNumber, e.endLineNumber + 1);
        }
        static {
            this.compareByStart = br((e) => e.startLineNumber, yr);
        }
        static joinMany(e) {
            if (0 === e.length) return [];
            let t = new xr(e[0].slice());
            for (let n = 1; n < e.length; n++)
                t = t.getUnion(new xr(e[n].slice()));
            return t.ranges;
        }
        static join(e) {
            if (0 === e.length) throw new o("lineRanges cannot be empty");
            let t = e[0].startLineNumber,
                n = e[0].endLineNumberExclusive;
            for (let r = 1; r < e.length; r++)
                ((t = Math.min(t, e[r].startLineNumber)),
                    (n = Math.max(n, e[r].endLineNumberExclusive)));
            return new Nr(t, n);
        }
        static deserialize(e) {
            return new Nr(e[0], e[1]);
        }
        constructor(e, t) {
            if (e > t)
                throw new o(
    ...
    class xr {
        ...
        contains(e) {
            const t = Cr(this._normalizedRanges, (t) => t.startLineNumber <= e);
        ...
        getUnion(e) {
            ...
            for (
                ...
                if (
                    ...
                    n < this._normalizedRanges.length
                        ? ((s = this._normalizedRanges[n]), n++)
                        : ((s = e._normalizedRanges[r]), r++);
                null === i
                    ? (i = s)
            ...
            return (null !== i && t.push(i), new xr(t));
        }
        subtractFrom(e) {
            const t = Lr(
                this._normalizedRanges,
            ...
            if (t === n) return new xr([e]);
            const r = [];
            let i = e.startLineNumber;
            for (let s = t; s < n; s++) {
                const e = this._normalizedRanges[s];
                (e.startLineNumber > i && r.push(new Nr(i, e.startLineNumber)),
                    (i = e.endLineNumberExclusive));
            }
            return (
                i < e.endLineNumberExclusive &&
                r.push(new Nr(i, e.endLineNumberExclusive)),
                new xr(r)
            );
        }
        toString() {
        ...
        getIntersection(e) {
            ...
            for (
                ...
                const i = this._normalizedRanges[n],
                    ...
                    o = i.intersect(s);
                (o && !o.isEmpty && t.push(o),
                    i.endLineNumberExclusive < s.endLineNumberExclusive
                        ? n++
                        : r++);
            }
            return new xr(t);
        ...
        getWithDelta(e) {
            return new xr(this._normalizedRanges.map((t) => t.delta(e)));
        }
    }
    class Er {
        static {
            this.zero = new Er(0, 0);
        }
        static betweenPositions(e, t) {
            return e.lineNumber === t.lineNumber
                ? new Er(0, t.column - e.column)
                : new Er(t.lineNumber - e.lineNumber, t.column - 1);
        }
        static fromPosition(e) {
            return new Er(e.lineNumber - 1, e.column - 1);
        }
        static ofRange(e) {
            return Er.betweenPositions(
                e.getStartPosition(),
                e.getEndPosition(),
            );
        }
        ...
        add(e) {
            return 0 === e.lineCount
                ? new Er(this.lineCount, this.columnCount + e.columnCount)
                : new Er(this.lineCount + e.lineCount, e.columnCount);
        }
        createRange(e) {
        ...
        toRange() {
            return new ke(1, 1, this.lineCount + 1, this.columnCount + 1);
        }
        toLineRange() {
            return Nr.ofLength(1, this.lineCount + 1);
        }
        addToPosition(e) {
            return 0 === this.lineCount
                ? new Ae(e.lineNumber, e.column + this.columnCount)
                : new Ae(e.lineNumber + this.lineCount, this.columnCount + 1);
        }
        toString() {
    ...
    class Rr extends Ar {
        ...
        getOffset(e) {
            ...
            return (
                this.lineStartOffsetByLineIdx[t.lineNumber - 1] + t.column - 1
            );
        }
        _validatePosition(e) {
            if (e.lineNumber < 1) return new Ae(1, 1);
            const t = this.textLength.lineCount + 1;
            if (e.lineNumber > t) {
                const e = this.getLineLength(t);
                return new Ae(t, e + 1);
            }
            if (e.column < 1) return new Ae(e.lineNumber, 1);
            const n = this.getLineLength(e.lineNumber);
            return e.column - 1 > n ? new Ae(e.lineNumber, n + 1) : e;
        }
        getPosition(e) {
            const t = _r(this.lineStartOffsetByLineIdx, (t) => t <= e),
                n = t + 1,
    ...
    class Tr {
        ...
        get endPositionExclusive() {
            return this.length.addToPosition(new Ae(1, 1));
        }
        get lineRange() {
        ...
        getLineLength(e) {
            return this.getValueOfRange(
                new ke(e, 1, e, Number.MAX_SAFE_INTEGER),
            ).length;
        }
        getTransformer() {
            return (
                this._transformer ||
                (this._transformer = new Rr(this.getValue())),
                this._transformer
            );
        }
        getLineAt(e) {
    ...
    class Mr extends Tr {
            ...
            (!(function (e, t = "unexpected state") {
                if (!e)
                    throw "string" == typeof t
                        ? new o(`Assertion Failed: ${t}`)
                        : t;
            })(t >= 1),
                super(),
                (this._getLineContent = e),
                (this._lineCount = t));
        }
        getValueOfRange(e) {
            ...
            let t = this._getLineContent(e.startLineNumber).substring(
                e.startColumn - 1,
            );
            for (let n = e.startLineNumber + 1; n < e.endLineNumber; n++)
                t += "\n" + this._getLineContent(n);
            return (
                (t +=
                    "\n" +
                    this._getLineContent(e.endLineNumber).substring(
                        0,
                        e.endColumn - 1,
                    )),
                t
        ...
        get length() {
            ...
            return new Er(this._lineCount - 1, e.length);
        }
    }
    class Or extends Mr {
        constructor(e) {
    ...
    class Ir {
        static joinReplacements(e, t) {
            ...
            const n = e[0].range.getStartPosition(),
                r = e[e.length - 1].range.getEndPosition();
            let i = "";
            for (let s = 0; s < e.length; s++) {
                const n = e[s];
                if (((i += n.text), s < e.length - 1)) {
                    const r = e[s + 1],
                        o = ke.fromPositions(
                            n.range.getEndPosition(),
                            r.range.getStartPosition(),
                        );
                    i += t.getValueOfRange(o);
                }
            }
            return new Ir(ke.fromPositions(n, r), i);
        }
        static fromStringReplacement(e, t) {
            return new Ir(
                t.getTransformer().getRange(e.replaceRange),
                e.newText,
            );
        }
        static delete(e) {
        ...
        removeCommonPrefix(e) {
            const t = e.getValueOfRange(this.range).replaceAll("\r\n", "\n"),
                ...
                i = Er.ofText(t.substring(0, r)).addToPosition(
                    this.range.getStartPosition(),
                ),
                s = n.substring(r),
                o = ke.fromPositions(i, this.range.getEndPosition());
            return new Ir(o, s);
        }
        removeCommonSuffix(e) {
            const t = e.getValueOfRange(this.range).replaceAll("\r\n", "\n"),
                ...
                i = Er.ofText(t.substring(0, t.length - r)).addToPosition(
                    this.range.getStartPosition(),
                ),
                s = n.substring(0, n.length - r),
                o = ke.fromPositions(this.range.getStartPosition(), i);
            return new Ir(o, s);
        }
        toString() {
            const e = this.range.getStartPosition(),
                t = this.range.getEndPosition();
    ...
    class Pr {
        static inverse(e, t, n) {
            ...
            for (const a of e) {
                const e = new Pr(
                    new Nr(i, a.original.startLineNumber),
                    new Nr(s, a.modified.startLineNumber),
                );
                (e.modified.isEmpty || r.push(e),
                    (i = a.original.endLineNumberExclusive),
                    (s = a.modified.endLineNumberExclusive));
            }
            const o = new Pr(new Nr(i, t + 1), new Nr(s, n + 1));
        ...
        static clip(e, t, n) {
            ...
            for (const i of e) {
                const e = i.original.intersect(t),
                    s = i.modified.intersect(n);
                e && !e.isEmpty && s && !s.isEmpty && r.push(new Pr(e, s));
            }
            return r;
        }
        constructor(e, t) {
        ...
        flip() {
            return new Pr(this.modified, this.original);
        }
        join(e) {
            return new Pr(
        ...
        toRangeMapping() {
            ...
            if (
                1 === this.original.startLineNumber ||
                1 === this.modified.startLineNumber
            ) {
                if (
                    1 !== this.modified.startLineNumber ||
                    1 !== this.original.startLineNumber
                )
                    throw new o("not a valid diff");
                return new qr(
                    new ke(
        ...
        toRangeMapping2(e, t) {
            if (
                Vr(this.original.endLineNumberExclusive, e) &&
                Vr(this.modified.endLineNumberExclusive, t)
            )
                return new qr(
                    new ke(
                        this.original.startLineNumber,
            ...
            if (!this.original.isEmpty && !this.modified.isEmpty)
                return new qr(
                    ke.fromPositions(
                        new Ae(this.original.startLineNumber, 1),
                        Fr(
                            new Ae(
                                this.original.endLineNumberExclusive - 1,
                                Number.MAX_SAFE_INTEGER,
                    ...
                    ke.fromPositions(
                        new Ae(this.modified.startLineNumber, 1),
                        Fr(
                            new Ae(
                                this.modified.endLineNumberExclusive - 1,
                                Number.MAX_SAFE_INTEGER,
    ...
    function Fr(e, t) {
        ...
        if (e.lineNumber > t.length)
            return new Ae(t.length, t[t.length - 1].length + 1);
        const n = t[e.lineNumber - 1];
        return e.column > n.length + 1 ? new Ae(e.lineNumber, n.length + 1) : e;
    }
    function Vr(e, t) {
    ...
    class Dr extends Pr {
        static fromRangeMappings(e) {
            const t = Nr.join(
                e.map((e) => Nr.fromRangeInclusive(e.originalRange)),
            ),
                n = Nr.join(
                    e.map((e) => Nr.fromRangeInclusive(e.modifiedRange)),
                );
            return new Dr(t, n, e);
        }
        constructor(e, t, n) {
        ...
        withInnerChangesFromLineRanges() {
            return new Dr(this.original, this.modified, [
                this.toRangeMapping(),
            ]);
        }
    }
    class qr {
        static fromEdit(e) {
            ...
            return e.replacements.map((e, n) => new qr(e.range, t[n]));
        }
        static assertSorted(e) {
            for (let t = 1; t < e.length; t++) {
                ...
                if (
                    !n.originalRange
                        .getEndPosition()
                        .isBeforeOrEqual(r.originalRange.getStartPosition()) ||
                    !n.modifiedRange
                        .getEndPosition()
                        .isBeforeOrEqual(r.modifiedRange.getStartPosition())
                )
                    throw new o("Range mappings must be sorted");
            }
        }
        constructor(e, t) {
        ...
        flip() {
            return new qr(this.modifiedRange, this.originalRange);
        }
        toTextEdit(e) {
            const t = e.getValueOfRange(this.modifiedRange);
            return new Ir(this.originalRange, t);
        }
    }
    function Kr(e, t, n, r = !1) {
        ...
        for (const s of (function* (e, t) {
            ...
            (e, t) =>
                e.original.intersectsOrTouches(t.original) ||
                e.modified.intersectsOrTouches(t.modified),
        )) {
            const e = s[0],
                t = s[s.length - 1];
            i.push(
        ...
        return (
            l(() => {
                if (!r && i.length > 0) {
                    if (
                        i[0].modified.startLineNumber !==
                        i[0].original.startLineNumber
                    )
                        return !1;
                    if (
                        n.length.lineCount -
    ...
    function Br(e, t, n, r) {
        return new Ee(e, t, n).ComputeDiff(r);
    }
    let Ur = class {
        constructor(e) {
            const t = [],
        ...
        createCharSequence(e, t, n) {
            ...
            for (let a = t; a <= n; a++) {
                ...
                !e &&
                    a < n &&
                    ((r[o] = 10), (i[o] = a + 1), (s[o] = t.length + 1), o++);
            }
            return new jr(r, i, s);
        }
    };
    ...
    class zr {
        ...
        static createFromDiffResult(e, t, n, r, i, s, o) {
            let a, l, u, c, h;
            if (
                (0 === t.originalLength
                ...
                if (s.getElements().length > 0 && a.getElements().length > 0) {
                    ...
                    for (let t = 0, n = e.length; t < n; t++)
                        h.push(Wr.createFromDiffChange(e[t], s, a));
                }
            }
            return new zr(a, l, u, c, h);
        }
    }
    class Hr {
        constructor(e, t, n) {
            ((this.shouldComputeCharChanges = n.shouldComputeCharChanges),
                ...
                (this.original = new Ur(e)),
                (this.modified = new Ur(t)),
                (this.continueLineDiff = Xr(n.maxComputationTime)),
        ...
        _pushTrimWhitespaceCharChange(e, t, n, r, i, s, o) {
            if (this._mergeTrimWhitespaceCharChange(e, t, n, r, i, s, o))
                return;
            let a;
            (this.shouldComputeCharChanges &&
                (a = [new Wr(t, n, t, r, i, s, i, o)]),
                e.push(new zr(t, t, i, i, a)));
        }
        _mergeTrimWhitespaceCharChange(e, t, n, r, i, s, o) {
            ...
            return (
                ...
                (l.originalEndLineNumber === t && l.modifiedEndLineNumber === i
                    ? (this.shouldComputeCharChanges &&
                        l.charChanges &&
                        l.charChanges.push(new Wr(t, n, t, r, i, s, i, o)),
                        !0)
    ...
    class Qr {
        static trivial(e, t) {
            return new Qr(
                [new Zr(wr.ofLength(e.length), wr.ofLength(t.length))],
                !1,
            );
        }
    ...
    class Zr {
            ...
            return (
                (function (e, t) {
                    for (let n = 0; n <= e.length; n++)
                        t(
                            0 === n ? void 0 : e[n - 1],
                            n === e.length ? void 0 : e[n],
                        );
                })(e, (e, r) => {
                    n.push(
                        Zr.fromOffsetPairs(
                            e ? e.getEndExclusives() : Yr.zero,
                            r
                                ? r.getStarts()
                                : new Yr(
                                    t,
        ...
        static fromOffsetPairs(e, t) {
            return new Zr(
                new wr(e.offset1, t.offset1),
                new wr(e.offset2, t.offset2),
            );
        }
        static assertSorted(e) {
            let t;
            for (const n of e) {
                if (
                    t &&
                    !(
                        t.seq1Range.endExclusive <= n.seq1Range.start &&
                        t.seq2Range.endExclusive <= n.seq2Range.start
                    )
                )
                    throw new o("Sequence diffs must be sorted");
                t = n;
            }
        }
        constructor(e, t) {
        ...
        swap() {
            return new Zr(this.seq2Range, this.seq1Range);
        }
        toString() {
        ...
        delta(e) {
            return 0 === e
                ? this
                : new Zr(this.seq1Range.delta(e), this.seq2Range.delta(e));
        }
        deltaStart(e) {
            return 0 === e
                ? this
    ...
    class Yr {
        static {
            this.zero = new Yr(0, 0);
        }
        static {
            this.max = new Yr(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
        }
        constructor(e, t) {
        ...
        delta(e) {
            return 0 === e ? this : new Yr(this.offset1 + e, this.offset2 + e);
        }
        equals(e) {
    ...
    class ii {
        ...
        computeSimilarity(e) {
            ...
            for (let r = 0; r < n; r++)
                t += Math.abs((this.histogram[r] ?? 0) - (e.histogram[r] ?? 0));
            return 1 - t / (this.totalCount + e.totalCount);
        }
    }
    class si {
        compute(e, t, n = ei.instance, r) {
            if (0 === e.length || 0 === t.length) return Qr.trivial(e, t);
            const i = new ni(e.length, t.length),
                s = new ni(e.length, t.length),
                o = new ni(e.length, t.length);
            for (let f = 0; f < e.length; f++)
                for (let a = 0; a < t.length; a++) {
                    if (!n.isValid()) return Qr.trivialTimedOut(e, t);
                    const l = 0 === f ? 0 : i.get(f - 1, a),
                        u = 0 === a ? 0 : i.get(f, a - 1);
                    let c;
                    e.getElement(f) === t.getElement(a)
                        ? ((c = 0 === f || 0 === a ? 0 : i.get(f - 1, a - 1)),
                            f > 0 &&
                            a > 0 &&
                            3 === s.get(f - 1, a - 1) &&
                            (c += o.get(f - 1, a - 1)),
                    ...
                    if (h === c) {
                        ...
                        h === l
                            ? (o.set(f, a, 0), s.set(f, a, 1))
                            : h === u && (o.set(f, a, 0), s.set(f, a, 2));
                    i.set(f, a, h);
                }
            const a = [];
            let l = e.length,
            ...
            function c(e, t) {
                ((e + 1 === l && t + 1 === u) ||
                    a.push(new Zr(new wr(e + 1, l), new wr(t + 1, u))),
                    (l = e),
                    (u = t));
            }
            let h = e.length - 1,
            ...
            for (; h >= 0 && d >= 0;)
                3 === s.get(h, d)
                    ...
                    : 1 === s.get(h, d)
                        ? h--
                        : d--;
            return (c(-1, -1), a.reverse(), new Qr(a, !1));
        }
    }
    class oi {
        compute(e, t, n = ei.instance) {
            if (0 === e.length || 0 === t.length) return Qr.trivial(e, t);
            const r = e,
                i = t;
            function s(e, t) {
            ...
            let u = 0;
            e: for (; ;) {
                if ((o++, !n.isValid())) return Qr.trivialTimedOut(r, i);
                const e = -Math.min(o, i.length + (o % 2)),
                    t = Math.min(o, r.length + (o % 2));
                for (u = e; u <= t; u += 2) {
                    const n = u === t ? -1 : a.get(u + 1),
                        o = u === e ? -1 : a.get(u - 1) + 1,
                        c = Math.min(Math.max(n, o), r.length),
                        h = c - u;
                    ...
                    if (
                        (l.set(u, d !== c ? new ai(f, c, h, d - c) : f),
            ...
            for (; ;) {
                ...
                if (
                    ((e === d && t === f) ||
                        h.push(new Zr(new wr(e, d), new wr(t, f))),
                        !c)
                )
                    break;
                ((d = c.x), (f = c.y), (c = c.prev));
            }
            return (h.reverse(), new Qr(h, !1));
        }
    }
    class ai {
        constructor(e, t, n, r) {
    ...
    class ci {
        constructor(e, t, n) {
            ...
            for (
                ...
                (r === this.range.startLineNumber &&
                    ...
                    ((i = this.range.startColumn - 1), (t = t.substring(i))),
                    this.lineStartOffsets.push(i));
                let s = 0;
                if (!n) {
                    const e = t.trimStart();
                ...
                const o =
                    r === this.range.endLineNumber
                        ? Math.min(this.range.endColumn - 1 - i - s, t.length)
                        : t.length;
        ...
        get text() {
            return this.getText(new wr(0, this.length));
        }
        getText(e) {
        ...
        getBoundaryScore(e) {
            const t = gi(e > 0 ? this.elements[e - 1] : -1),
                n = gi(e < this.elements.length ? this.elements[e] : -1);
            if (7 === t && 8 === n) return 0;
            if (8 === t) return 150;
            let r = 0;
            return (
        ...
        translateOffset(e, t = "right") {
            const n = _r(this.firstElementOffsetByLineIdx, (t) => t <= e),
        ...
        translateRange(e) {
            ...
            return n.isBefore(t)
                ? ke.fromPositions(n, n)
                : ke.fromPositions(t, n);
        }
        findWordContaining(e) {
            if (e < 0 || e >= this.elements.length) return;
            if (!hi(this.elements[e])) return;
            let t = e;
        ...
        findSubWordContaining(e) {
            ...
            if (!hi(this.elements[e])) return;
            let t = e;
            for (; t > 0 && hi(this.elements[t - 1]) && !di(this.elements[t]);)
                t--;
            let n = e;
            for (
                ;
        ...
        extendToFullLines(e) {
            const t =
                Cr(this.firstElementOffsetByLineIdx, (t) => t <= e.start) ??
                0,
                n =
                    (function (e, t) {
                        const n = Lr(e, t);
    ...
    const fi = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 };
    function mi(e) {
        return fi[e];
    }
    function gi(e) {
    ...
    function pi(e, t, n, r, i, s) {
        let { moves: o, excludedChanges: a } = (function (e, t, n, r) {
            const i = [],
                s = e
                    ...
                    .map((e) => new ii(e.original, t, e)),
                o = new Set(
                    e
                        .filter(
                            (e) => e.original.isEmpty && e.modified.length >= 3,
                        )
                        .map((e) => new ii(e.modified, n, e)),
                ),
                a = new Set();
            for (const l of s) {
                let e,
        ...
        const l = (function (e, t, n, r, i, s) {
            ...
            for (const f of e)
                for (
                    let e = f.original.startLineNumber;
                    e < f.original.endLineNumberExclusive - 2;
                    e++
                ) {
                    const n = `${t[e - 1]}:${t[e + 1 - 1]}:${t[e + 2 - 1]}`;
                    a.add(n, { range: new Nr(e, e + 3) });
                }
            const l = [];
            e.sort(br((e) => e.modified.startLineNumber, yr));
            for (const f of e) {
                let e = [];
                for (
                    let t = f.modified.startLineNumber;
                    t < f.modified.endLineNumberExclusive - 2;
                    t++
                ) {
                    const r = `${n[t - 1]}:${n[t + 1 - 1]}:${n[t + 2 - 1]}`,
                        i = new Nr(t, t + 3),
                        s = [];
                    (a.forEach(r, ({ range: t }) => {
                        for (const r of e)
                            if (
                                ...
                                return (
                                    (r.originalLineRange = new Nr(
                                        r.originalLineRange.startLineNumber,
                                        t.endLineNumberExclusive,
                                    )),
                                    (r.modifiedLineRange = new Nr(
            ...
            l.sort(
                ((u = br((e) => e.modifiedLineRange.length, yr)),
                    (e, t) => -u(e, t)),
            );
            var u;
            const c = new xr(),
            ...
            for (const f of l) {
                const e =
                    ...
                    t = c.subtractFrom(f.modifiedLineRange),
                    n = h.subtractFrom(f.originalLineRange).getWithDelta(e),
                    r = t.getIntersection(n);
                for (const i of r.ranges) {
                    if (i.length < 3) continue;
                    const t = i,
                        n = i.delta(-e);
                    (o.push(new Pr(n, t)), c.addRange(t), h.addRange(n));
                }
            }
            o.sort(br((e) => e.original.startLineNumber, yr));
            const d = new Sr(e);
            for (let f = 0; f < o.length; f++) {
                const t = o[f],
                    n = d.findLastMonotonous(
                        (e) =>
                    ...
                    l = Math.max(
                        t.original.startLineNumber - n.original.startLineNumber,
                        t.modified.startLineNumber - a.modified.startLineNumber,
                    ),
                    u = d.findLastMonotonous(
                        (e) =>
                            e.original.startLineNumber <
                ...
                let p, b;
                for (p = 0; p < l; p++) {
                    const e = t.original.startLineNumber - p - 1,
                        n = t.modified.startLineNumber - p - 1;
                    if (e > r.length || n > i.length) break;
                    if (c.contains(n) || h.contains(e)) break;
                    if (!bi(r[e - 1], i[n - 1], s)) break;
                }
                for (
                    p > 0 &&
                    (h.addRange(
                        new Nr(
                            t.original.startLineNumber - p,
                            t.original.startLineNumber,
                        ),
                    ),
                        c.addRange(
                            new Nr(
                                t.modified.startLineNumber - p,
                                t.modified.startLineNumber,
                            ),
                        )),
                    b = 0;
                    ...
                    const e = t.original.endLineNumberExclusive + b,
                        n = t.modified.endLineNumberExclusive + b;
                    if (e > r.length || n > i.length) break;
                    if (c.contains(n) || h.contains(e)) break;
                    if (!bi(r[e - 1], i[n - 1], s)) break;
                }
        ...
        return (
            ...
            (o = (function (e) {
                ...
                e.sort(br((e) => e.original.startLineNumber, yr));
                const t = [e[0]];
                for (let n = 1; n < e.length; n++) {
    ...
    function bi(e, t, n) {
        ...
        const r = new oi().compute(
            new ci([e], new ke(1, 1, 1, e.length), !1),
            new ci([t], new ke(1, 1, 1, t.length), !1),
            n,
        );
        let i = 0;
        const s = Zr.invert(r.diffs, e.length);
        for (const a of s)
            a.seq1Range.forEach((t) => {
                ri(e.charCodeAt(t)) || i++;
            });
        const o = (function (t) {
            let n = 0;
            for (let r = 0; r < e.length; r++) ri(t.charCodeAt(r)) || n++;
            return n;
    ...
    function vi(e, t, n) {
        ...
        for (let s = 1; s < n.length; s++) {
            ...
            if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
                ...
                if ((s--, s === n)) {
                    r[r.length - 1] = new Zr(
                        new wr(i.seq1Range.start, o.seq1Range.endExclusive - n),
                        new wr(i.seq2Range.start, o.seq2Range.endExclusive - n),
                    );
                    continue;
                }
                o = o.delta(-s);
        ...
        for (let s = 0; s < r.length - 1; s++) {
            ...
            if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
                ...
                for (
                    ...
                    e.isStronglyEqual(
                        o.seq1Range.start + a,
                        o.seq1Range.endExclusive + a,
                    ) &&
                    t.isStronglyEqual(
                        o.seq2Range.start + a,
                        o.seq2Range.endExclusive + a,
                    );
                    a++
                );
                if (a === i) {
                    r[s + 1] = new Zr(
                        new wr(o.seq1Range.start + i, n.seq1Range.endExclusive),
                        new wr(o.seq2Range.start + i, n.seq2Range.endExclusive),
                    );
                    continue;
                }
                a > 0 && (o = o.delta(a));
    ...
    function wi(e, t, n, r, i) {
        ...
        for (
            ;
            e.seq1Range.start - s >= r.start &&
            e.seq2Range.start - s >= i.start &&
            n.isStronglyEqual(
                e.seq2Range.start - s,
        ...
        for (
            ...
            e.seq2Range.endExclusive + o < i.endExclusive &&
            n.isStronglyEqual(
                e.seq2Range.start + o,
        ...
        let a = 0,
            l = -1;
        for (let u = -s; u <= o; u++) {
            const r = e.seq2Range.start + u,
                i = e.seq2Range.endExclusive + u,
                s = e.seq1Range.start + u,
                o =
                    t.getBoundaryScore(s) +
                    n.getBoundaryScore(r) +
    ...
    function Ci(e, t, n, r, i = !1) {
        const s = Zr.invert(n, e.length),
            o = [];
        let a = new Yr(0, 0);
        function l(n, l) {
            if (n.offset1 < a.offset1 || n.offset2 < a.offset2) return;
            const u = r(e, n.offset1),
                c = r(t, n.offset2);
            if (!u || !c) return;
            let h = new Zr(u, c);
            const d = h.intersect(l);
            let f = d.seq1Range.length,
                m = d.seq2Range.length;
            for (; s.length > 0;) {
                const n = s[0];
                if (
                    !(
                        n.seq1Range.intersects(h.seq1Range) ||
                        n.seq2Range.intersects(h.seq2Range)
                    )
                )
                    break;
                const i = r(e, n.seq1Range.start),
                    o = r(t, n.seq2Range.start),
                    a = new Zr(i, o),
                    l = a.intersect(n);
                if (
                    ((f += l.seq1Range.length),
            ...
            (((i && f + m < h.seq1Range.length + h.seq2Range.length) ||
                f + m < (2 * (h.seq1Range.length + h.seq2Range.length)) / 3) &&
                o.push(h),
                (a = h.getEndExclusives()));
        }
        for (; s.length > 0;) {
            const e = s.shift();
            e.seq1Range.isEmpty ||
    ...
    class _i {
        ...
        getBoundaryScore(e) {
            return (
                1e3 -
                ((0 === e ? 0 : Li(this.lines[e - 1])) +
                    (e === this.lines.length ? 0 : Li(this.lines[e])))
            );
        }
        getText(e) {
    ...
    class Si {
        constructor() {
            ((this.dynamicProgrammingDiffing = new si()),
                (this.myersDiffingAlgorithm = new oi()));
        }
        computeDiff(e, t, n) {
            if (
                e.length <= 1 &&
            ...
            const a = e.map((e) => o(e.trim())),
                u = t.map((e) => o(e.trim())),
                c = new _i(a, e),
                h = new _i(u, t),
                d = (() =>
                    c.length + h.length < 1700
                        ...
                        : this.myersDiffingAlgorithm.compute(c, h, r))();
            let f = d.diffs,
                m = d.hitTimeout;
            ((f = yi(c, h, f)),
                (f = (function (e, t, n) {
                        ...
                        for (let o = 0; o < s; o++) {
                            ...
                            if (e[s] !== t[a]) {
                                const o = this.refineDiff(
                                    e,
                                    t,
                                    new Zr(new wr(s, s + 1), new wr(a, a + 1)),
                                    r,
                                    i,
                                    n,
                                );
            ...
            let b = 0,
                y = 0;
            for (const L of f) {
                l(() => L.seq1Range.start - b === L.seq2Range.start - y);
                (p(L.seq1Range.start - b),
                    (b = L.seq1Range.endExclusive),
                    (y = L.seq2Range.endExclusive));
                const s = this.refineDiff(e, t, L, r, i, n);
                s.hitTimeout && (m = !0);
            ...
            return (
                n.computeMoves &&
                (_ = this.computeMoves(C, e, t, a, u, r, i, n)),
                l(() => {
                    function n(e, t) {
        ...
        computeMoves(e, t, n, r, i, s, o, a) {
            return pi(e, t, n, r, i, s).map((e) => {
                const r = Kr(
                    this.refineDiff(
                        t,
                        n,
                        new Zr(
                            e.original.toOffsetRange(),
                            e.modified.toOffsetRange(),
                        ),
                        s,
                        o,
                        a,
        ...
        refineDiff(e, t, n, r, i, s) {
            ...
            const a = new Pr(
                ...
                new Nr(o.seq2Range.start + 1, o.seq2Range.endExclusive + 1),
            ).toRangeMapping2(e, t),
                l = new ci(e, a.originalRange, i),
                u = new ci(t, a.modifiedRange, i),
                c =
                    l.length + u.length < 500
                        ? this.dynamicProgrammingDiffing.compute(l, u, r)
                        : this.myersDiffingAlgorithm.compute(l, u, r);
            let h = c.diffs;
            ((h = yi(l, u, h)),
                (h = Ci(l, u, h, (e, t) => e.findWordContaining(t))),
                s.extendToSubwords &&
                (h = Ci(l, u, h, (e, t) => e.findSubWordContaining(t), !0)),
                (h = (function (e, t, n) {
                    const r = [];
                    for (const i of n) {
                    ...
                    do {
                        ...
                        for (let l = 1; l < r.length; l++) {
                            ...
                            function h(n, r) {
                                ...
                                if (e.countLinesIn(i) > 5 || i.length > 500)
                                    return !1;
                                ...
                                if (
                                    ...
                                    return !1;
                                const o = e.countLinesIn(n.seq1Range),
                                    a = n.seq1Range.length,
                                    l = t.countLinesIn(n.seq2Range),
                                    h = n.seq2Range.length,
                                    d = e.countLinesIn(r.seq1Range),
                                    f = r.seq1Range.length,
                                    m = t.countLinesIn(r.seq2Range),
                                    g = r.seq2Range.length;
                                function p(e) {
                                    return Math.min(e, 130);
                                }
                                return (
                                    Math.pow(
                                        Math.pow(p(40 * o + a), 1.5) +
                                        Math.pow(p(40 * l + h), 1.5),
                                        1.5,
                                    ) +
                                    Math.pow(
                                        Math.pow(p(40 * d + f), 1.5) +
                                        Math.pow(p(40 * m + g), 1.5),
                                        1.5,
                                    ) >
                                    74184.96480721243
                                );
                            ...
                            h(c, u)
                                ? ((i = !0),
                                    (a[a.length - 1] = a[a.length - 1].join(u)))
                                : a.push(u);
                        }
                        r = a;
                    } while (s++ < 10 && i);
                    ...
                    return (
                        (function (e, t) {
                            ...
                            const a = e.extendToFullLines(n.seq1Range),
                                l = e.getText(
                                    new wr(a.start, n.seq1Range.start),
                                );
                            s(l) && (i = i.deltaStart(-l.length));
                            const u = e.getText(
                                new wr(
                                    n.seq1Range.endExclusive,
                                    a.endExclusive,
                                ),
                            );
                            s(u) && (i = i.deltaEnd(u.length));
                            const c = Zr.fromOffsetPairs(
                                t ? t.getEndExclusives() : Yr.zero,
                                r ? r.getStarts() : Yr.max,
                            ),
                                h = i.intersect(c);
                            o.length > 0 &&
                                h
                                ...
                                ? (o[o.length - 1] = o[o.length - 1].join(h))
                                : o.push(h);
                        }),
                        o
                    );
            ...
            return {
                mappings: h.map(
                    (e) =>
                        new qr(
                            l.translateRange(e.seq1Range),
                            u.translateRange(e.seq2Range),
                        ),
                ),
    ...
    class Ai {
        constructor(e, t, n, r = 1) {
            ((this._rgbaBrand = void 0),
                ...
                (this.a = Ei(Math.max(Math.min(1, r), 0), 3)));
        }
        static equals(e, t) {
    ...
    class ki {
        constructor(e, t, n, r) {
            ((this._hslaBrand = void 0),
                ...
                (this.s = Ei(Math.max(Math.min(1, t), 0), 3)),
                (this.l = Ei(Math.max(Math.min(1, n), 0), 3)),
                (this.a = Ei(Math.max(Math.min(1, r), 0), 3)));
        }
        static equals(e, t) {
        ...
        static toRGBA(e) {
            ...
            if (0 === n) s = o = a = r;
                ...
                const e = r < 0.5 ? r * (1 + n) : r + n - r * n,
                    i = 2 * r - e;
                ((s = ki._hue2rgb(i, e, t + 1 / 3)),
                    (o = ki._hue2rgb(i, e, t)),
                    (a = ki._hue2rgb(i, e, t - 1 / 3)));
            }
            return new Ai(
                Math.round(255 * s),
                Math.round(255 * o),
    ...
    class Ri {
        constructor(e, t, n, r) {
            ((this._hsvaBrand = void 0),
                (this.h = 0 | Math.max(Math.min(360, e), 0)),
                (this.s = Ei(Math.max(Math.min(1, t), 0), 3)),
                (this.v = Ei(Math.max(Math.min(1, n), 0), 3)),
                (this.a = Ei(Math.max(Math.min(1, r), 0), 3)));
        }
        static equals(e, t) {
                    ...
                    0 === s
                        ...
                        : i === t
                            ...
                            : i === n
                                ? (r - t) / s + 2
                                : (t - n) / s + 4),
                new Ri(Math.round(60 * a), o, i, e.a)
            );
        }
        static toRGBA(e) {
    ...
    let Ti = class e {
        ...
        get hsla() {
            return this._hsla ? this._hsla : ki.fromRGBA(this.rgba);
        }
        get hsva() {
            return this._hsva ? this._hsva : Ri.fromRGBA(this.rgba);
        }
        constructor(e) {
            if (!e) throw new Error("Color needs a value");
            if (e instanceof Ai) this.rgba = e;
            else if (e instanceof ki)
                ((this._hsla = e), (this.rgba = ki.toRGBA(e)));
            else {
                if (!(e instanceof Ri))
                    throw new Error("Invalid color ctor argument");
                ((this._hsva = e), (this.rgba = Ri.toRGBA(e)));
            }
        }
        equals(e) {
            return (
                !!e &&
                Ai.equals(this.rgba, e.rgba) &&
                ki.equals(this.hsla, e.hsla) &&
                Ri.equals(this.hsva, e.hsva)
            );
        }
        ...
        toString() {
            return (
                this._toString || (this._toString = e.Format.CSS.format(this)),
                this._toString
            );
        }
        toNumber32Bit() {
        ...
        static getDarkerColor(e, t, n) {
            ...
            const r = e.getRelativeLuminance();
            return (
                (n = (n * (r - t.getRelativeLuminance())) / r),
                e.darken(n)
            );
        }
        static {
            this.white = new e(new Ai(255, 255, 255, 1));
        }
        static {
            this.black = new e(new Ai(0, 0, 0, 1));
        }
        static {
            this.red = new e(new Ai(255, 0, 0, 1));
        }
        static {
            this.blue = new e(new Ai(0, 0, 255, 1));
        }
        static {
            this.green = new e(new Ai(0, 255, 0, 1));
        }
        static {
            this.cyan = new e(new Ai(0, 255, 255, 1));
        }
        static {
            this.lightgrey = new e(new Ai(211, 211, 211, 1));
        }
        static {
            this.transparent = new e(new Ai(0, 0, 0, 0));
        }
    };
    function Mi(e) {
        const t = [];
    ...
    function Pi(e, t) {
        if (!e) return;
        const n = Ti.Format.CSS.parseHex(t);
        return n
            ? { range: e, color: Oi(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) }
            : void 0;
    }
    function Fi(e, t, n) {
        if (!e || 1 !== t.length) return;
        const r = Mi(t[0].values());
        return { range: e, color: Oi(r[0], r[1], r[2], n ? r[3] : 1) };
    }
    function Vi(e, t, n) {
        if (!e || 1 !== t.length) return;
        const r = Mi(t[0].values()),
            i = new Ti(new ki(r[0], r[1] / 100, r[2] / 100, n ? r[3] : 1));
        return { range: e, color: Oi(i.rgba.r, i.rgba.g, i.rgba.b, i.rgba.a) };
    }
    function Di(e, t) {
        ...
        (function (t) {
            ...
            function r(t) {
                ...
                if (7 === n) {
                    const n = 16 * i(t.charCodeAt(1)) + i(t.charCodeAt(2)),
                        ...
                        s = 16 * i(t.charCodeAt(5)) + i(t.charCodeAt(6));
                    return new e(new Ai(n, r, s, 1));
                }
                if (9 === n) {
                    const n = 16 * i(t.charCodeAt(1)) + i(t.charCodeAt(2)),
                        r = 16 * i(t.charCodeAt(3)) + i(t.charCodeAt(4)),
                        s = 16 * i(t.charCodeAt(5)) + i(t.charCodeAt(6)),
                        o = 16 * i(t.charCodeAt(7)) + i(t.charCodeAt(8));
                    return new e(new Ai(n, r, s, o / 255));
                }
                if (4 === n) {
                    const n = i(t.charCodeAt(1)),
                        r = i(t.charCodeAt(2)),
                        s = i(t.charCodeAt(3));
                    return new e(new Ai(16 * n + n, 16 * r + r, 16 * s + s));
                }
                if (5 === n) {
                    const n = i(t.charCodeAt(1)),
                        r = i(t.charCodeAt(2)),
            ...
            ((t.formatRGB = function (t) {
                ...
                (t.formatHSL = function (t) {
                    return 1 === t.hsla.a
                        ? `hsl(${t.hsla.h}, ${Math.round(100 * t.hsla.s)}%, ${Math.round(100 * t.hsla.l)}%)`
                ...
                (t.formatHexA = function (t, r = !1) {
                    return r && 1 === t.rgba.a
                        ...
                        : `#${n(t.rgba.r)}${n(t.rgba.g)}${n(t.rgba.b)}${n(Math.round(255 * t.rgba.a))}`;
                }),
                (t.format = function (t) {
                    return t.isOpaque()
                        ? e.Format.CSS.formatHex(t)
                ...
                (t.parse = function (t) {
                    ...
                    if (t.startsWith("rgba(")) {
                        ...
                        const r = parseInt(n.groups?.r ?? "0"),
                            i = parseInt(n.groups?.g ?? "0"),
                            s = parseInt(n.groups?.b ?? "0"),
                            o = parseFloat(n.groups?.a ?? "0");
                        return new e(new Ai(r, i, s, o));
                    }
                    if (t.startsWith("rgb(")) {
                        const n = t.match(
                            /rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/,
                        ...
                        const r = parseInt(n.groups?.r ?? "0"),
                            i = parseInt(n.groups?.g ?? "0"),
                            s = parseInt(n.groups?.b ?? "0");
                        return new e(new Ai(r, i, s));
                    }
                    return (function (t) {
                        switch (t) {
                            case "aliceblue":
                                return new e(new Ai(240, 248, 255, 1));
                            case "antiquewhite":
                                return new e(new Ai(250, 235, 215, 1));
                            case "aqua":
                            case "cyan":
                                return new e(new Ai(0, 255, 255, 1));
                            case "aquamarine":
                                return new e(new Ai(127, 255, 212, 1));
                            case "azure":
                                return new e(new Ai(240, 255, 255, 1));
                            case "beige":
                                return new e(new Ai(245, 245, 220, 1));
                            case "bisque":
                                return new e(new Ai(255, 228, 196, 1));
                            case "black":
                                return new e(new Ai(0, 0, 0, 1));
                            case "blanchedalmond":
                                return new e(new Ai(255, 235, 205, 1));
                            case "blue":
                                return new e(new Ai(0, 0, 255, 1));
                            case "blueviolet":
                                return new e(new Ai(138, 43, 226, 1));
                            case "brown":
                                return new e(new Ai(165, 42, 42, 1));
                            case "burlywood":
                                return new e(new Ai(222, 184, 135, 1));
                            case "cadetblue":
                                return new e(new Ai(95, 158, 160, 1));
                            case "chartreuse":
                                return new e(new Ai(127, 255, 0, 1));
                            case "chocolate":
                                return new e(new Ai(210, 105, 30, 1));
                            case "coral":
                                return new e(new Ai(255, 127, 80, 1));
                            case "cornflowerblue":
                                return new e(new Ai(100, 149, 237, 1));
                            case "cornsilk":
                                return new e(new Ai(255, 248, 220, 1));
                            case "crimson":
                                return new e(new Ai(220, 20, 60, 1));
                            case "darkblue":
                                return new e(new Ai(0, 0, 139, 1));
                            case "darkcyan":
                                return new e(new Ai(0, 139, 139, 1));
                            case "darkgoldenrod":
                                return new e(new Ai(184, 134, 11, 1));
                            case "darkgray":
                            case "darkgrey":
                                return new e(new Ai(169, 169, 169, 1));
                            case "darkgreen":
                                return new e(new Ai(0, 100, 0, 1));
                            case "darkkhaki":
                                return new e(new Ai(189, 183, 107, 1));
                            case "darkmagenta":
                                return new e(new Ai(139, 0, 139, 1));
                            case "darkolivegreen":
                                return new e(new Ai(85, 107, 47, 1));
                            case "darkorange":
                                return new e(new Ai(255, 140, 0, 1));
                            case "darkorchid":
                                return new e(new Ai(153, 50, 204, 1));
                            case "darkred":
                                return new e(new Ai(139, 0, 0, 1));
                            case "darksalmon":
                                return new e(new Ai(233, 150, 122, 1));
                            case "darkseagreen":
                                return new e(new Ai(143, 188, 143, 1));
                            case "darkslateblue":
                                return new e(new Ai(72, 61, 139, 1));
                            case "darkslategray":
                            case "darkslategrey":
                                return new e(new Ai(47, 79, 79, 1));
                            case "darkturquoise":
                                return new e(new Ai(0, 206, 209, 1));
                            case "darkviolet":
                                return new e(new Ai(148, 0, 211, 1));
                            case "deeppink":
                                return new e(new Ai(255, 20, 147, 1));
                            case "deepskyblue":
                                return new e(new Ai(0, 191, 255, 1));
                            case "dimgray":
                            case "dimgrey":
                                return new e(new Ai(105, 105, 105, 1));
                            case "dodgerblue":
                                return new e(new Ai(30, 144, 255, 1));
                            case "firebrick":
                                return new e(new Ai(178, 34, 34, 1));
                            case "floralwhite":
                                return new e(new Ai(255, 250, 240, 1));
                            case "forestgreen":
                                return new e(new Ai(34, 139, 34, 1));
                            case "fuchsia":
                            case "magenta":
                                return new e(new Ai(255, 0, 255, 1));
                            case "gainsboro":
                                return new e(new Ai(220, 220, 220, 1));
                            case "ghostwhite":
                                return new e(new Ai(248, 248, 255, 1));
                            case "gold":
                                return new e(new Ai(255, 215, 0, 1));
                            case "goldenrod":
                                return new e(new Ai(218, 165, 32, 1));
                            case "gray":
                            case "grey":
                                return new e(new Ai(128, 128, 128, 1));
                            case "green":
                                return new e(new Ai(0, 128, 0, 1));
                            case "greenyellow":
                                return new e(new Ai(173, 255, 47, 1));
                            case "honeydew":
                                return new e(new Ai(240, 255, 240, 1));
                            case "hotpink":
                                return new e(new Ai(255, 105, 180, 1));
                            case "indianred":
                                return new e(new Ai(205, 92, 92, 1));
                            case "indigo":
                                return new e(new Ai(75, 0, 130, 1));
                            case "ivory":
                                return new e(new Ai(255, 255, 240, 1));
                            case "khaki":
                                return new e(new Ai(240, 230, 140, 1));
                            case "lavender":
                                return new e(new Ai(230, 230, 250, 1));
                            case "lavenderblush":
                                return new e(new Ai(255, 240, 245, 1));
                            case "lawngreen":
                                return new e(new Ai(124, 252, 0, 1));
                            case "lemonchiffon":
                                return new e(new Ai(255, 250, 205, 1));
                            case "lightblue":
                                return new e(new Ai(173, 216, 230, 1));
                            case "lightcoral":
                                return new e(new Ai(240, 128, 128, 1));
                            case "lightcyan":
                                return new e(new Ai(224, 255, 255, 1));
                            case "lightgoldenrodyellow":
                                return new e(new Ai(250, 250, 210, 1));
                            case "lightgray":
                            case "lightgrey":
                                return new e(new Ai(211, 211, 211, 1));
                            case "lightgreen":
                                return new e(new Ai(144, 238, 144, 1));
                            case "lightpink":
                                return new e(new Ai(255, 182, 193, 1));
                            case "lightsalmon":
                                return new e(new Ai(255, 160, 122, 1));
                            case "lightseagreen":
                                return new e(new Ai(32, 178, 170, 1));
                            case "lightskyblue":
                                return new e(new Ai(135, 206, 250, 1));
                            case "lightslategray":
                            case "lightslategrey":
                                return new e(new Ai(119, 136, 153, 1));
                            case "lightsteelblue":
                                return new e(new Ai(176, 196, 222, 1));
                            case "lightyellow":
                                return new e(new Ai(255, 255, 224, 1));
                            case "lime":
                                return new e(new Ai(0, 255, 0, 1));
                            case "limegreen":
                                return new e(new Ai(50, 205, 50, 1));
                            case "linen":
                                return new e(new Ai(250, 240, 230, 1));
                            case "maroon":
                                return new e(new Ai(128, 0, 0, 1));
                            case "mediumaquamarine":
                                return new e(new Ai(102, 205, 170, 1));
                            case "mediumblue":
                                return new e(new Ai(0, 0, 205, 1));
                            case "mediumorchid":
                                return new e(new Ai(186, 85, 211, 1));
                            case "mediumpurple":
                                return new e(new Ai(147, 112, 219, 1));
                            case "mediumseagreen":
                                return new e(new Ai(60, 179, 113, 1));
                            case "mediumslateblue":
                                return new e(new Ai(123, 104, 238, 1));
                            case "mediumspringgreen":
                                return new e(new Ai(0, 250, 154, 1));
                            case "mediumturquoise":
                                return new e(new Ai(72, 209, 204, 1));
                            case "mediumvioletred":
                                return new e(new Ai(199, 21, 133, 1));
                            case "midnightblue":
                                return new e(new Ai(25, 25, 112, 1));
                            case "mintcream":
                                return new e(new Ai(245, 255, 250, 1));
                            case "mistyrose":
                                return new e(new Ai(255, 228, 225, 1));
                            case "moccasin":
                                return new e(new Ai(255, 228, 181, 1));
                            case "navajowhite":
                                return new e(new Ai(255, 222, 173, 1));
                            case "navy":
                                return new e(new Ai(0, 0, 128, 1));
                            case "oldlace":
                                return new e(new Ai(253, 245, 230, 1));
                            case "olive":
                                return new e(new Ai(128, 128, 0, 1));
                            case "olivedrab":
                                return new e(new Ai(107, 142, 35, 1));
                            case "orange":
                                return new e(new Ai(255, 165, 0, 1));
                            case "orangered":
                                return new e(new Ai(255, 69, 0, 1));
                            case "orchid":
                                return new e(new Ai(218, 112, 214, 1));
                            case "palegoldenrod":
                                return new e(new Ai(238, 232, 170, 1));
                            case "palegreen":
                                return new e(new Ai(152, 251, 152, 1));
                            case "paleturquoise":
                                return new e(new Ai(175, 238, 238, 1));
                            case "palevioletred":
                                return new e(new Ai(219, 112, 147, 1));
                            case "papayawhip":
                                return new e(new Ai(255, 239, 213, 1));
                            case "peachpuff":
                                return new e(new Ai(255, 218, 185, 1));
                            case "peru":
                                return new e(new Ai(205, 133, 63, 1));
                            case "pink":
                                return new e(new Ai(255, 192, 203, 1));
                            case "plum":
                                return new e(new Ai(221, 160, 221, 1));
                            case "powderblue":
                                return new e(new Ai(176, 224, 230, 1));
                            case "purple":
                                return new e(new Ai(128, 0, 128, 1));
                            case "rebeccapurple":
                                return new e(new Ai(102, 51, 153, 1));
                            case "red":
                                return new e(new Ai(255, 0, 0, 1));
                            case "rosybrown":
                                return new e(new Ai(188, 143, 143, 1));
                            case "royalblue":
                                return new e(new Ai(65, 105, 225, 1));
                            case "saddlebrown":
                                return new e(new Ai(139, 69, 19, 1));
                            case "salmon":
                                return new e(new Ai(250, 128, 114, 1));
                            case "sandybrown":
                                return new e(new Ai(244, 164, 96, 1));
                            case "seagreen":
                                return new e(new Ai(46, 139, 87, 1));
                            case "seashell":
                                return new e(new Ai(255, 245, 238, 1));
                            case "sienna":
                                return new e(new Ai(160, 82, 45, 1));
                            case "silver":
                                return new e(new Ai(192, 192, 192, 1));
                            case "skyblue":
                                return new e(new Ai(135, 206, 235, 1));
                            case "slateblue":
                                return new e(new Ai(106, 90, 205, 1));
                            case "slategray":
                            case "slategrey":
                                return new e(new Ai(112, 128, 144, 1));
                            case "snow":
                                return new e(new Ai(255, 250, 250, 1));
                            case "springgreen":
                                return new e(new Ai(0, 255, 127, 1));
                            case "steelblue":
                                return new e(new Ai(70, 130, 180, 1));
                            case "tan":
                                return new e(new Ai(210, 180, 140, 1));
                            case "teal":
                                return new e(new Ai(0, 128, 128, 1));
                            case "thistle":
                                return new e(new Ai(216, 191, 216, 1));
                            case "tomato":
                                return new e(new Ai(255, 99, 71, 1));
                            case "turquoise":
                                return new e(new Ai(64, 224, 208, 1));
                            case "violet":
                                return new e(new Ai(238, 130, 238, 1));
                            case "wheat":
                                return new e(new Ai(245, 222, 179, 1));
                            case "white":
                                return new e(new Ai(255, 255, 255, 1));
                            case "whitesmoke":
                                return new e(new Ai(245, 245, 245, 1));
                            case "yellow":
                                return new e(new Ai(255, 255, 0, 1));
                            case "yellowgreen":
                                return new e(new Ai(154, 205, 50, 1));
                            default:
                                return null;
                        }
                    })(t);
            ...
            const r = (function (e, t) {
                ...
                for (let i = 1; i <= r; i++) {
                    const r = e.getLineContent(i),
                        s = r.match(t.foldingRules.markers.start);
                    if (s) {
                        const e = {
                            startLineNumber: i,
    ...
    function Ui(e) {
        ...
        return { text: (e = e.replace(Ki, "")), hasSeparatorLine: t };
    }
    class ji {
        get isRejected() {
    ...
    class Hi {
        ...
        produceFinal(e) {
            ...
            for (const t of this._unsatisfiedConsumers)
                this._resolveOrRejectDeferred(t, e);
            this._unsatisfiedConsumers.length = 0;
        }
        _ensureNoFinalValue() {
    ...
    class Gi {
                    ...
                    const t = e({
                        emitOne: (e) =>
                            this._producerConsumer.produce({
                                ok: !0,
                                value: { done: !1, value: e },
                            }),
                        emitMany: (e) => {
                            for (const t of e)
                                this._producerConsumer.produce({
                                    ok: !0,
                                    value: { done: !1, value: t },
                                });
                        },
        ...
        static merge(e) {
            return new Gi(async (t) => {
                await Promise.all(
                    e.map(async (e) => {
                        for await (const n of e) t.emitOne(n);
                    }),
                );
            });
        }
        static {
            this.EMPTY = Gi.fromArray([]);
        }
        static map(e, t) {
            return new Gi(async (n) => {
                for await (const r of e) n.emitOne(t(r));
            });
        }
        map(e) {
            return Gi.map(this, e);
        }
        static coalesce(e) {
            return Gi.filter(e, (e) => !!e);
        }
        coalesce() {
            return Gi.coalesce(this);
        }
        static filter(e, t) {
            return new Gi(async (n) => {
                for await (const r of e) t(r) && n.emitOne(r);
            });
        }
        filter(e) {
            return Gi.filter(this, e);
        }
        _finishOk() {
    ...
    class Ji {
        ...
        getPrefixSum(e) {
            return e < 0 ? 0 : ((e = Te(e)), this._getPrefixSum(e));
        }
        _getPrefixSum(e) {
            ...
            for (const n of t)
                (this._acceptDeleteRange(n.range),
                    this._acceptInsertText(
                        new Ae(n.range.startLineNumber, n.range.startColumn),
                        n.text,
                    ));
    ...
    class Yi extends Qi {
        ...
        findMatches(e) {
            ...
            for (let n = 0; n < this._lines.length; n++) {
                const r = this._lines[n],
                    i = this.offsetAt(new Ae(n + 1, 1)),
                    s = r.matchAll(e);
                for (const e of s)
                    ((e.index || 0 === e.index) && (e.index = e.index + i),
                        t.push(e));
            }
            return t;
        }
        ...
        getWordAtPosition(e, t) {
            const n = ur(e.column, ar(t), this._lines[e.lineNumber - 1], 0);
            return n
                ? new ke(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn)
                : null;
        }
        words(e) {
            const t = this._lines,
        ...
        _validatePosition(e) {
            if (!Ae.isIPosition(e)) throw new Error("bad position");
    ...
    class es {
        constructor(e = null) {
            ((this._foreignModule = e),
                ...
                (this._workerTextModelSyncServer = new Zi()));
        }
        dispose() { }
        async $ping() {
            return "pong";
        ...
        async $computeUnicodeHighlights(e, t, n) {
            ...
            return r
                ? hr.computeUnicodeHighlights(r, t, n)
                : {
                    ranges: [],
                    hasMore: !1,
        ...
        async $computeDiff(e, t, n, r) {
            const i = this._getModel(e),
                s = this._getModel(t);
            if (!i || !s) return null;
            return es.computeDiff(i, s, n, r);
        }
        static computeDiff(e, t, n, r) {
            const i = "advanced" === r ? xi() : Ni(),
                s = e.getLinesContent(),
                o = t.getLinesContent(),
                a = i.computeDiff(s, o, n);
            function l(e) {
                return e.map((e) => [
                    e.original.startLineNumber,
                    e.original.endLineNumberExclusive,
        ...
        async $computeMoreMinimalEdits(e, t, n) {
            ...
            t = t.slice(0).sort((e, t) => {
                if (e.range && t.range)
                    return ke.compareRangesUsingStarts(e.range, t.range);
                return (e.range ? 0 : 1) - (t.range ? 0 : 1);
            });
            let o = 0;
            for (let a = 1; a < t.length; a++)
                ke
                    .getEndPosition(t[o].range)
                    .equals(ke.getStartPosition(t[a].range))
                    ? ((t[o].range = ke.fromPositions(
                        ke.getStartPosition(t[o].range),
                        ke.getEndPosition(t[a].range),
                    )),
                        (t[o].text += t[a].text))
                    : (o++, (t[o] = t[a]));
            t.length = o + 1;
            for (let { range: a, text: l, eol: u } of t) {
                if (("number" == typeof u && (s = u), ke.isEmpty(a) && !l))
                    continue;
                const e = r.getValueInRange(a);
                if (((l = l.replace(/\r\n|\n|\r/g, r.eol)), e === l)) continue;
                if (Math.max(l.length, e.length) > es._diffLimit) {
                    i.push({ range: a, text: l });
                    continue;
                }
                const t = Le(e, l, n),
                    o = r.offsetAt(ke.lift(a).getStartPosition());
                for (const n of t) {
                    const e = r.positionAt(o + n.originalStart),
                        t = r.positionAt(
                            o + n.originalStart + n.originalLength,
                        ),
                        s = {
                            text: l.substr(n.modifiedStart, n.modifiedLength),
                            range: {
                    ...
                    r.getValueInRange(s.range) !== s.text && i.push(s);
                }
            }
            return (
                "number" == typeof s &&
                ...
                if (e)
                    for (const n of e.words(s))
                        if (
                            n !== t &&
                            isNaN(Number(n)) &&
                            (o.add(n), o.size > es._suggestionsLimit)
                        )
                            break e;
            }
        ...
        async $navigateValueSet(e, t, n, r, i) {
            ...
            return De.INSTANCE.navigateValueSet(t, a, l, u, n);
        }
        $fmr(e, t) {
            if (
                !this._foreignModule ||
    ...
    class ts {
        ...
        static getChannel(e) {
            return e.getChannel(ts.CHANNEL_NAME);
        }
        static setChannel(e, t) {
            e.setChannel(ts.CHANNEL_NAME, t);
        }
    }
    function ns(e) {
        let t;
            ...
            switch (t) {
                ...
                case 47:
                    ...
                    if (47 === e.charCodeAt(r + 1)) {
                        for (r += 2; r < n && !ss(e.charCodeAt(r));) r++;
                    ...
                    return (
                        (i += (function () {
                            ...
                            if (48 === e.charCodeAt(r)) r++;
                                ...
                                for (r++; r < e.length && os(e.charCodeAt(r));)
                                    r++;
                            if (r < e.length && 46 === e.charCodeAt(r)) {
                                if (
                                    (r++,
                                        !(r < e.length && os(e.charCodeAt(r))))
                                )
    ...
    const as = new Array(20).fill(0).map((e, t) => " ".repeat(t)),
        ls = 200,
        us = {
            " ": {
                "\n": new Array(ls).fill(0).map((e, t) => "\n" + " ".repeat(t)),
                "\r": new Array(ls).fill(0).map((e, t) => "\r" + " ".repeat(t)),
                "\r\n": new Array(ls)
                    .fill(0)
                    .map((e, t) => "\r\n" + " ".repeat(t)),
            },
    ...
    function hs(e, t, n) {
        ...
        if (t) {
            for (
                o = t.offset, a = o + t.length, s = o;
                s > 0 && !fs(e, s - 1);
            )
                s--;
            let l = a;
            for (; l < e.length && !fs(e, l);) l++;
            ((i = e.substring(s, l)),
                (r = (function (e, t) {
                    let n = 0,
                        r = 0;
        ...
        let c,
            ...
            d = 0;
        c = n.insertSpaces
            ? (as[n.tabSize || 4] ?? ds(as[1], n.tabSize || 4))
            : "\t";
        const f = "\t" === c ? "\t" : " ";
        let m = rs(i, !1),
            g = !1;
        function p() {
            if (h > 1) return ds(l, h) + ds(c, r + d);
            const e = c.length * (r + d);
            return !u || e > us[f][l].length
                ? l + ds(c, r + d)
                : e <= 0
                    ? l
                    : us[f][l][e];
        ...
        let w = b();
        if ((n.keepLines && h > 0 && v(ds(l, h), 0, 0), 17 !== w)) {
            let e = m.getTokenOffset() + s;
            v(
                c.length * r < 20 && n.insertSpaces
                    ? as[c.length * r]
                    : ds(c, r),
                s,
                e,
        ...
        for (; 17 !== w;) {
            let e = m.getTokenOffset() + m.getTokenLength() + s,
                t = b(),
                r = "",
                i = !1;
            for (; 0 === h && (12 === t || 13 === t);) {
                ...
                (v(as[1], e, n),
                    (e = m.getTokenOffset() + m.getTokenLength() + s),
                    (i = 12 === t),
                    (r = i ? p() : ""),
                    (t = b()));
            }
            ...
            17 === t &&
                (r =
                    n.keepLines && h > 0 ? p() : n.insertFinalNewline ? l : "");
    ...
    const ys = function (e, t = [], n = ms.DEFAULT) {
        let r = null,
            i = [];
        const s = [];
        function o(e) {
        ...
        return (
            (function (e, t, n = ms.DEFAULT) {
                ...
                const u = o(t.onObjectBegin),
                    c = l(t.onObjectProperty),
                    h = s(t.onObjectEnd),
                    d = o(t.onArrayBegin),
                    f = s(t.onArrayEnd),
                ...
                if ((w(), 17 === r.getToken()))
                    return !!n.allowEmptyContent || (C(4, [], []), !1);
                if (!E()) return (C(4, [], []), !1);
                17 !== r.getToken() && C(9, [], []);
            })(
                e,
    ...
    function Jo(e, t) {
        ...
        if (Array.isArray(e)) {
            if (e.length !== t.length) return !1;
            for (n = 0; n < e.length; n++) if (!Jo(e[n], t[n])) return !1;
        } else {
            const i = [];
            for (r in e) i.push(r);
            i.sort();
            const s = [];
            for (r in t) s.push(r);
            if ((s.sort(), !Jo(i, s))) return !1;
            for (n = 0; n < i.length; n++) if (!Jo(e[i[n]], t[i[n]])) return !1;
        }
        return !0;
    }
    function Xo(e) {
    ...
    (!(function (e) {
        ...
        (function (e) {
            ((e.create = function (e, t) {
                return (
                    e === Number.MAX_VALUE && (e = xs.MAX_VALUE),
                    t === Number.MAX_VALUE && (t = xs.MAX_VALUE),
                    { line: e, character: t }
                );
            }),
                (e.is = function (e) {
        ...
        (function (e) {
            ((e.create = function (e, t, n, r) {
                if (
                    ...
                    return { start: Es.create(e, t), end: Es.create(n, r) };
                if (Es.is(e) && Es.is(t)) return { start: e, end: t };
                throw new Error(
                ...
                (e.is = function (e) {
                    let t = e;
                    return (
                        sa.objectLiteral(t) && Es.is(t.start) && Es.is(t.end)
                    );
                }));
        })(As || (As = {})),
        (function (e) {
            ((e.create = function (e, t) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        sa.objectLiteral(t) &&
                        As.is(t.range) &&
                        (sa.string(t.uri) || sa.undefined(t.uri))
                    );
                }));
        })(ks || (ks = {})),
        (function (e) {
            ((e.create = function (e, t, n, r) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        sa.objectLiteral(t) &&
                        As.is(t.targetRange) &&
                        sa.string(t.targetUri) &&
                        As.is(t.targetSelectionRange) &&
                        (As.is(t.originSelectionRange) ||
                            sa.undefined(t.originSelectionRange))
                    );
                }));
        })(Rs || (Rs = {})),
        (function (e) {
            ((e.create = function (e, t, n, r) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        sa.objectLiteral(t) &&
                        sa.numberRange(t.red, 0, 1) &&
                        sa.numberRange(t.green, 0, 1) &&
                        sa.numberRange(t.blue, 0, 1) &&
                        sa.numberRange(t.alpha, 0, 1)
                    );
                }));
        })(Ts || (Ts = {})),
        (function (e) {
            ((e.create = function (e, t) {
                ...
                (e.is = function (e) {
                    const t = e;
                    return (
                        sa.objectLiteral(t) && As.is(t.range) && Ts.is(t.color)
                    );
                }));
        })(Ms || (Ms = {})),
        (function (e) {
            ((e.create = function (e, t, n) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        sa.objectLiteral(t) &&
                        sa.string(t.label) &&
                        (sa.undefined(t.textEdit) || Bs.is(t)) &&
                        (sa.undefined(t.additionalTextEdits) ||
                            sa.typedArray(t.additionalTextEdits, Bs.is))
                    );
                }));
        })(Os || (Os = {})),
        (function (e) {
        ...
        (function (e) {
            ((e.create = function (e, t, n, r, i, s) {
                const o = { startLine: e, endLine: t };
                return (
                    sa.defined(n) && (o.startCharacter = n),
                    sa.defined(r) && (o.endCharacter = r),
                    sa.defined(i) && (o.kind = i),
                    sa.defined(s) && (o.collapsedText = s),
                    o
                );
            }),
                (e.is = function (e) {
                    ...
                    return (
                        sa.objectLiteral(t) &&
                        sa.uinteger(t.startLine) &&
                        sa.uinteger(t.startLine) &&
                        (sa.undefined(t.startCharacter) ||
                            sa.uinteger(t.startCharacter)) &&
                        (sa.undefined(t.endCharacter) ||
                            sa.uinteger(t.endCharacter)) &&
                        (sa.undefined(t.kind) || sa.string(t.kind))
                    );
                }));
        })(Ps || (Ps = {})),
        (function (e) {
        ...
        (function (e) {
            e.is = function (e) {
                const t = e;
                return sa.objectLiteral(t) && sa.string(t.href);
            };
        })(qs || (qs = {})),
        (function (e) {
            ((e.create = function (e, t, n, r, i, s) {
                ...
                return (
                    sa.defined(n) && (o.severity = n),
                    sa.defined(r) && (o.code = r),
                    sa.defined(i) && (o.source = i),
                    sa.defined(s) && (o.relatedInformation = s),
                    o
                );
            }),
                (e.is = function (e) {
                    ...
                    return (
                        ...
                        As.is(n.range) &&
                        sa.string(n.message) &&
                        (sa.number(n.severity) || sa.undefined(n.severity)) &&
                        (sa.integer(n.code) ||
                            sa.string(n.code) ||
                            sa.undefined(n.code)) &&
                        (sa.undefined(n.codeDescription) ||
                            sa.string(
                                null === (t = n.codeDescription) || void 0 === t
                                    ? void 0
                                    : t.href,
                            )) &&
                        (sa.string(n.source) || sa.undefined(n.source)) &&
                        (sa.undefined(n.relatedInformation) ||
                            sa.typedArray(n.relatedInformation, Fs.is))
                    );
                }));
        })(Ks || (Ks = {})),
        (function (e) {
            ((e.create = function (e, t, ...n) {
                ...
                return (sa.defined(n) && n.length > 0 && (r.arguments = n), r);
            }),
                (e.is = function (e) {
                    let t = e;
                    return (
            ...
            ((e.create = function (e, t, n) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        sa.objectLiteral(t) &&
                        sa.string(t.label) &&
                        (sa.boolean(t.needsConfirmation) ||
                            void 0 === t.needsConfirmation) &&
                        (sa.string(t.description) || void 0 === t.description)
                    );
                }));
        })(Us || (Us = {})),
        (function (e) {
        ...
        (function (e) {
            ((e.replace = function (e, t, n) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        Bs.is(t) &&
                        (Us.is(t.annotationId) || js.is(t.annotationId))
                    );
                }));
        })(Ws || (Ws = {})),
        (function (e) {
                    ...
                    return (
                        ...
                        (void 0 === t.options ||
                            ((void 0 === t.options.overwrite ||
                                sa.boolean(t.options.overwrite)) &&
                                (void 0 === t.options.ignoreIfExists ||
                                    sa.boolean(t.options.ignoreIfExists)))) &&
                        (void 0 === t.annotationId || js.is(t.annotationId))
                    );
                }));
        })(Hs || (Hs = {})),
        (function (e) {
                    ...
                    return (
                        ...
                        (void 0 === t.options ||
                            ((void 0 === t.options.recursive ||
                                sa.boolean(t.options.recursive)) &&
                                (void 0 === t.options.ignoreIfNotExists ||
                                    sa.boolean(
                                        t.options.ignoreIfNotExists,
                                    )))) &&
                        (void 0 === t.annotationId || js.is(t.annotationId))
                    );
                }));
        ...
        (function (e) {
            ((e.create = function (e) {
                ...
                (e.is = function (e) {
                    let t = e;
                    return sa.defined(t) && sa.string(t.uri);
                }));
        })(Qs || (Qs = {})),
        (function (e) {
            ((e.create = function (e, t) {
            ...
            ((e.create = function (e, t) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        sa.defined(t) &&
                        sa.string(t.uri) &&
                        (null === t.version || sa.integer(t.version))
                    );
                }));
        })(Ys || (Ys = {})),
        (function (e) {
        ...
        (function (e) {
            e.is = function (e) {
                const t = e;
                return (
                    sa.objectLiteral(e) && to.is(t.kind) && sa.string(t.value)
                );
            };
        })(no || (no = {})),
        (function (e) {
        ...
        (function (e) {
            e.is = function (e) {
                ...
                return (
                    t &&
                    (sa.string(t.detail) || void 0 === t.detail) &&
                    (sa.string(t.description) || void 0 === t.description)
                );
            };
        })(lo || (lo = {})),
        ...
        (function (e) {
            e.is = function (e) {
                ...
                return (
                    ...
                    (no.is(t.contents) ||
                        ho.is(t.contents) ||
                        sa.typedArray(t.contents, ho.is)) &&
                    (void 0 === e.range || As.is(e.range))
                );
            };
        })(fo || (fo = {})),
        (function (e) {
        ...
        (function (e) {
            e.create = function (e, t, ...n) {
                let r = { label: e };
                return (
                    sa.defined(t) && (r.documentation = t),
                    sa.defined(n) ? (r.parameters = n) : (r.parameters = []),
                    r
                );
            };
        })(go || (go = {})),
        ...
        (function (e) {
            e.create = function (e, t, n, r, i) {
                let s = { name: e, kind: t, location: { uri: r, range: n } };
            ...
            ((e.create = function (e, t, n, r, i, s) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        ...
                        sa.number(t.kind) &&
                        As.is(t.range) &&
                        As.is(t.selectionRange) &&
                        (void 0 === t.detail || sa.string(t.detail)) &&
                        (void 0 === t.deprecated || sa.boolean(t.deprecated)) &&
        ...
        (function (e) {
            ((e.create = function (e, t, n) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        sa.defined(t) &&
                        sa.typedArray(t.diagnostics, Ks.is) &&
                        (void 0 === t.only ||
                            sa.typedArray(t.only, sa.string)) &&
                        (void 0 === t.triggerKind ||
                            t.triggerKind === So.Invoked ||
                            t.triggerKind === So.Automatic)
                    );
                }));
        })(No || (No = {})),
        (function (e) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        ...
                        (void 0 === t.diagnostics ||
                            sa.typedArray(t.diagnostics, Ks.is)) &&
                        (void 0 === t.kind || sa.string(t.kind)) &&
                        (void 0 !== t.edit || void 0 !== t.command) &&
                        (void 0 === t.command || $s.is(t.command)) &&
                        (void 0 === t.isPreferred ||
                            sa.boolean(t.isPreferred)) &&
                        (void 0 === t.edit || Xs.is(t.edit))
                    );
                }));
        })(xo || (xo = {})),
        (function (e) {
            ((e.create = function (e, t) {
                let n = { range: e };
                return (sa.defined(t) && (n.data = t), n);
            }),
                (e.is = function (e) {
                    let t = e;
                    return (
                        sa.defined(t) &&
                        As.is(t.range) &&
                        (sa.undefined(t.command) || $s.is(t.command))
                    );
                }));
        })(Eo || (Eo = {})),
        (function (e) {
            ((e.create = function (e, t) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        sa.defined(t) &&
                        sa.uinteger(t.tabSize) &&
                        sa.boolean(t.insertSpaces)
                    );
                }));
        })(Ao || (Ao = {})),
        (function (e) {
            ((e.create = function (e, t, n) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        sa.defined(t) &&
                        As.is(t.range) &&
                        (sa.undefined(t.target) || sa.string(t.target))
                    );
                }));
        })(ko || (ko = {})),
        (function (e) {
        ...
        (function (e) {
            ((e.create = function (e, t) {
                ...
                (e.is = function (e) {
                    const t = e;
                    return null != t && As.is(t.range) && sa.string(t.text);
                }));
        })(Io || (Io = {})),
        (function (e) {
            ((e.create = function (e, t, n) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        null != t &&
                        As.is(t.range) &&
                        sa.boolean(t.caseSensitiveLookup) &&
                        (sa.string(t.variableName) || void 0 === t.variableName)
                    );
                }));
        })(Po || (Po = {})),
        (function (e) {
            ((e.create = function (e, t) {
                ...
                (e.is = function (e) {
                    ...
                    return (
                        null != t &&
                        As.is(t.range) &&
                        (sa.string(t.expression) || void 0 === t.expression)
                    );
                }));
        })(Fo || (Fo = {})),
        (function (e) {
            ((e.create = function (e, t) {
                ...
                (e.is = function (e) {
                    const t = e;
                    return sa.defined(t) && As.is(e.stoppedLocation);
                }));
        })(Vo || (Vo = {})),
        (function (e) {
            ((e.Type = 1),
                ...
                (e.is = function (e) {
                    ...
                    return (
                        ...
                        (void 0 === t.tooltip ||
                            sa.string(t.tooltip) ||
                            no.is(t.tooltip)) &&
                        (void 0 === t.location || ks.is(t.location)) &&
                        (void 0 === t.command || $s.is(t.command))
                    );
                }));
        })(qo || (qo = {})),
                ...
                (e.is = function (e) {
                    ...
                    return (
                        (sa.objectLiteral(t) &&
                            Es.is(t.position) &&
                            (sa.string(t.label) ||
                                sa.typedArray(t.label, qo.is)) &&
                            (void 0 === t.kind || Do.is(t.kind)) &&
                            void 0 === t.textEdits) ||
                        (sa.typedArray(t.textEdits, Bs.is) &&
                            (void 0 === t.tooltip ||
                                sa.string(t.tooltip) ||
                                no.is(t.tooltip)) &&
                            (void 0 === t.paddingLeft ||
                                sa.boolean(t.paddingLeft)) &&
                            (void 0 === t.paddingRight ||
                                sa.boolean(t.paddingRight)))
                    );
                }));
        })(Ko || (Ko = {})),
        (function (e) {
        ...
        (function (e) {
            e.is = function (e) {
                const t = e;
                return sa.objectLiteral(t) && Ss.is(t.uri) && sa.string(t.name);
            };
        })(Ho || (Ho = {})),
        (function (e) {
            function t(e, n) {
            ...
            ((e.create = function (e, t, n, r) {
                ...
                (e.is = function (e) {
                    ...
                    return !!(
                        sa.defined(t) &&
                        sa.string(t.uri) &&
                        (sa.undefined(t.languageId) ||
                            sa.string(t.languageId)) &&
                        sa.uinteger(t.lineCount) &&
                        sa.func(t.getText) &&
                        sa.func(t.positionAt) &&
                        sa.func(t.offsetAt)
                    );
                }),
    ...
    let ia = class {
        ...
        positionAt(e) {
            ...
            let t = this.getLineOffsets(),
                n = 0,
                r = t.length;
            if (0 === r) return Es.create(0, e);
            for (; n < r;) {
                let i = Math.floor((n + r) / 2);
                t[i] > e ? (r = i) : (n = i + 1);
            }
            let i = n - 1;
            return Es.create(i, e - t[i]);
        }
        offsetAt(e) {
            let t = this.getLineOffsets();
            ...
            for (let n of e)
                if (ca.isIncremental(n)) {
                    ...
                    const i = Math.max(e.start.line, 0),
                        s = Math.max(e.end.line, 0);
                    let o = this._lineOffsets;
                    const a = da(n.text, !1, t);
                    if (s - i === a.length)
                    ...
                    if (0 !== l)
                        for (let n = i + 1 + a.length, u = o.length; n < u; n++)
                            o[n] = o[n] + l;
                } else {
                    if (!ca.isFull(n))
    ...
    (!(function (e) {
        ((e.create = function (e, t, n, r) {
            ...
            (e.update = function (e, t, n) {
                if (e instanceof ca) return (e.update(t, n), e);
                throw new Error(
            ...
            (e.applyEdits = function (e, t) {
                ...
                for (const o of r) {
                    ...
                    (t > i && s.push(n.substring(i, t)),
                        o.newText.length && s.push(o.newText),
                        (i = e.offsetAt(o.range.end)));
                }
        ...
        (function (e) {
            ((e[(e.Undefined = 0)] = "Undefined"),
                ...
                (e[(e.Deprecated = 2)] = "Deprecated"),
                (e[(e.UnexpectedEndOfComment = 257)] =
                ...
                (e[(e.InvalidEscapeCharacter = 261)] =
        ...
        (function (e) {
            e.LATEST = {
                textDocument: {
                    completion: {
                        completionItem: {
                            documentationFormat: [to.Markdown, to.PlainText],
    ...
    const ba = {
        ...
        "date-time": {
            errorMessage: ga("String is not a RFC3339 date-time."),
            pattern:
                /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i,
        },
        date: {
            errorMessage: ga("String is not a RFC3339 date."),
            pattern: /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/i,
        },
        time: {
            errorMessage: ga("String is not a RFC3339 time."),
            pattern:
                /^([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i,
        },
        email: {
            errorMessage: ga("String is not an e-mail address."),
            pattern:
                /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z0-9-]+\.)+[a-zA-Z]{2,}))$/,
        },
        hostname: {
            errorMessage: ga("String is not a hostname."),
            pattern:
                /^(?=.{1,253}\.?$)[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?(?:\.[a-z0-9](?:[-0-9a-z]{0,61}[0-9a-z])?)*\.?$/i,
        },
        ipv4: {
            errorMessage: ga("String is not an IPv4 address."),
            pattern:
                /^(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)$/,
        },
        ipv6: {
            errorMessage: ga("String is not an IPv6 address."),
            pattern:
    ...
    const Aa = {
        "http://json-schema.org/draft-03/schema#": la.v3,
        "http://json-schema.org/draft-04/schema#": la.v4,
        "http://json-schema.org/draft-06/schema#": la.v6,
        "http://json-schema.org/draft-07/schema#": la.v7,
        "https://json-schema.org/draft/2019-09/schema": la.v2019_09,
        "https://json-schema.org/draft/2020-12/schema": la.v2020_12,
    };
    class ka {
        constructor(e) {
            this.schemaDraft = e;
    ...
    class Ra {
        ...
        include(e) {
            return (
                (-1 === this.focusOffset || Pa(e, this.focusOffset)) &&
                e !== this.exclude
            );
        }
        newSub() {
            return new Ra(-1, this.exclude);
        }
    }
    class Ta {
        constructor() { }
    ...
    class Ma {
        ...
        mergeProcessedProperties(e) {
            e.processedProperties.forEach((e) =>
                this.processedProperties.add(e),
            );
        }
        compare(e) {
    ...
    class Fa {
        ...
        getNodeFromOffset(e, t = !1) {
            if (this.root) return vs(this.root, e, t);
        }
        visit(e) {
            if (this.root) {
                const t = (n) => {
        ...
        validate(e, t, n = Vs.Warning, r) {
            if (this.root && t) {
                const i = new Ma();
                return (
                    Da(this.root, t, i, Ta.instance, new ka(r ?? Va(t))),
                    i.problems.map((t) => {
                        const r = As.create(
                            e.positionAt(t.location.offset),
                            e.positionAt(t.location.offset + t.location.length),
                        );
                        return Ks.create(r, t.message, t.severity ?? n, t.code);
                    })
                );
            }
        }
        getMatchingSchemas(e, t = -1, n) {
            if (this.root && e) {
                const r = new Ra(t, n),
                    i = Va(e),
                    s = new ka(i);
                return (Da(this.root, e, new Ma(), r, s), r.schemas);
            }
            return [];
        }
    }
    function Va(e, t = la.v2020_12) {
        let n = e.$schema;
        return n ? (Aa[n] ?? t) : t;
    }
    function Da(e, t, n, r, i) {
        if (!e || !r.include(e)) return;
        if ("property" === e.type) return Da(e.valueNode, t, n, r, i);
        const s = e;
        switch (
        ((function () {
            function e(e) {
                return (
                    s.type === e ||
                    ("integer" === e && "number" === s.type && s.isInteger)
                );
            }
            Array.isArray(t.type)
                ...
                (e(t.type) ||
                    n.problems.push({
                        ...
                        message:
                            t.errorMessage ||
                            ga('Incorrect type. Expected "{0}".', t.type),
                    }));
            if (Array.isArray(t.allOf))
                for (const h of t.allOf) {
                    const e = new Ma(),
                        t = r.newSub();
                    (Da(s, xa(h), e, t, i), n.merge(e), r.merge(t));
                }
            const o = xa(t.not);
            if (o) {
                const e = new Ma(),
                ...
                (Da(s, o, e, a, i),
                    ...
                    n.problems.push({
                        ...
                        message:
                            t.errorMessage ||
                            ga("Matches a schema that is not allowed."),
                    }));
                for (const t of a.schemas)
                    ((t.inverted = !t.inverted), r.add(t));
            }
            const a = (e, t) => {
                const o = [];
                let a;
                for (const n of e) {
                    const e = xa(n),
                        ...
                        u = r.newSub();
                    if (
                        (Da(s, e, l, u, i), l.hasProblems() || o.push(e), a)
                    )
                        if (
                            t ||
                            l.hasProblems() ||
                            ...
                            (a.matchingSchemas.merge(u),
                                ...
                                a.validationResult.mergeProcessedProperties(
                                    l,
                                ));
                    else
                        a = {
            ...
            const l = (e) => {
                const t = new Ma(),
                    o = r.newSub();
                (Da(s, xa(e), t, o, i), n.merge(t), r.merge(o));
            },
                u = xa(t.if);
            u &&
                ((e, t, o) => {
                    ...
                    (Da(s, a, u, c, i),
                        r.merge(c),
                        n.mergeProcessedProperties(u),
                        u.hasProblems() ? o && l(o) : t && l(t));
                })(u, xa(t.then), xa(t.else));
            ...
            case "object":
                !(function (e) {
                    ...
                    if (Array.isArray(t.required))
                        for (const r of t.required)
                            if (!s[r]) {
                                ...
                                n.problems.push({
                                    location: i,
                                    message: ga('Missing property "{0}".', r),
                                });
                            }
                    const a = (e) => {
                    ...
                    if (t.properties)
                        for (const d of Object.keys(t.properties)) {
                            a(d);
                            const e = t.properties[d],
                                o = s[d];
                            if (o)
                                if (Zo(e))
                                    if (e)
                    ...
                    if (t.patternProperties)
                        for (const d of Object.keys(t.patternProperties)) {
                            const e = na(d);
                            if (e) {
                                const l = [];
                                for (const a of o)
                    ...
                    if (t.dependentRequired)
                        for (const n in t.dependentRequired) {
                            const e = s[n],
                                r = t.dependentRequired[n];
                            e && Array.isArray(r) && h(n, r);
                        }
                    if (t.dependentSchemas)
                        for (const n in t.dependentSchemas) {
                            const e = s[n],
                                r = t.dependentSchemas[n];
                            e && ea(r) && h(n, r);
                        }
                    if (t.dependencies)
                        for (const n in t.dependencies) {
                            s[n] && h(n, t.dependencies[n]);
                        }
                    const c = xa(t.propertyNames);
                    if (c)
                        for (const t of e.properties) {
                            const e = t.keyNode;
                            e && Da(e, c, n, Ta.instance, i);
                        }
                    function h(t, o) {
                        if (Array.isArray(o))
                            for (const r of o)
                            ...
                            if (t) {
                                const s = new Ma();
                                (Da(e, t, s, r, i), n.mergePropertyMatch(s));
                            }
                        }
                    }
                })(s);
            ...
            case "array":
                !(function (e) {
                    let s, o;
                    i.schemaDraft >= la.v2020_12
                        ? ((s = t.prefixItems),
                            (o = Array.isArray(t.items) ? void 0 : t.items))
                        : ((s = Array.isArray(t.items) ? t.items : void 0),
                            (o = Array.isArray(t.items)
                                ? t.additionalItems
                                : t.items));
                    let a = 0;
                    if (void 0 !== s) {
                        const c = Math.min(s.length, e.items.length);
                        for (; a < c; a++) {
                            const h = xa(s[a]),
                                d = new Ma(),
                                f = e.items[a];
                            (f && (Da(f, h, d, r, i), n.mergePropertyMatch(d)),
                                n.processedProperties.add(String(a)));
                        }
                    }
                    if (void 0 !== o && a < e.items.length)
                        if ("boolean" == typeof o)
                            for (
                                !1 === o &&
                                n.problems.push({
                            ...
                            for (; a < e.items.length; a++) {
                                const m = new Ma();
                                (Da(e.items[a], o, m, r, i),
                                    n.mergePropertyMatch(m),
                                    n.processedProperties.add(String(a)));
                            }
                    const l = xa(t.contains);
                    if (l) {
                        let g = 0;
                        for (let p = 0; p < e.items.length; p++) {
                            const b = e.items[p],
                                y = new Ma();
                            (Da(b, l, y, Ta.instance, i),
                                y.hasProblems() ||
                                (g++,
                                    i.schemaDraft >= la.v2020_12 &&
                                    n.processedProperties.add(String(p))));
                        }
                        (0 !== g ||
                            Xo(t.minContains) ||
                            n.problems.push({
                                ...
                                message:
                                    t.errorMessage ||
                                    ga("Array does not contain required item."),
                            }),
                            Xo(t.minContains) &&
                            g < t.minContains &&
                            n.problems.push({
                    ...
                    if (void 0 !== u)
                        for (let v = 0; v < e.items.length; v++) {
                            if (!n.processedProperties.has(String(v)))
                                if (!1 === u)
                                    n.problems.push({
                                        location: {
                                            offset: e.offset,
                    ...
                    if (!0 === t.uniqueItems) {
                        ...
                        function _() {
                            for (let e = 0; e < C.length - 1; e++) {
                                const t = C[e];
                                for (let n = e + 1; n < C.length; n++)
                                    if (Jo(t, C[n])) return !0;
                            }
                            return !1;
                        }
                        _() &&
                            n.problems.push({
                                ...
                                message: ga("Array has duplicate items."),
                            });
                    }
                })(s);
                break;
                            ...
                            case "uri-reference":
                                {
                                    ...
                                    if (e.value) {
                                        ...
                                        n
                                            ...
                                            : (r = ga("URI is expected."));
                                    } else r = ga("URI expected.");
                                    r &&
                                        n.problems.push({
                                            location: {
                                                offset: e.offset,
                ...
                !(function (e) {
                    ...
                    if (Xo(t.multipleOf)) {
                        ...
                        if (Number.isInteger(t.multipleOf))
                            ...
                            if (e && n) {
                                const t =
                                    10 ** Math.abs(n.multiplier - e.multiplier);
    ...
    function qa(e, t) {
                ...
                switch ((c(), t)) {
                    ...
                    case 13:
                        Array.isArray(o) &&
                            o.push(
                                As.create(
                                    e.positionAt(s.getTokenOffset()),
                                    e.positionAt(
                                        s.getTokenOffset() + s.getTokenLength(),
                                    ),
                                ),
                            );
                        break;
        ...
        function l(t, i, s, o, a = Vs.Error) {
            if (0 === n.length || s !== r) {
                const l = As.create(e.positionAt(s), e.positionAt(o));
                (n.push(Ks.create(l, t, a, i, e.languageId)), (r = s));
            }
        }
        function u(e, t, n = void 0, r = [], o = []) {
            let u = s.getTokenOffset(),
                c = s.getTokenOffset() + s.getTokenLength();
            if (u === c && u > 0) {
        ...
        function c() {
            switch (s.getTokenError()) {
                case 4:
                    return (
                        u(
                            ga("Invalid unicode sequence in string."),
                            aa.InvalidUnicode,
                        ),
                        !0
                    );
                case 5:
                    return (
                        u(
                            ga("Invalid escape character in string."),
        ...
        const d = new La(void 0, 0, 0);
        function f(t, n) {
            const r = new Sa(t, s.getTokenOffset(), d);
            let i = m(r);
            if (!i) {
                if (16 !== s.getToken()) return;
                {
                    u(
                        ga("Property keys must be doublequoted"),
                        aa.PropertyKeysMustBeDoublequoted,
                    );
                    const e = new La(r, s.getTokenOffset(), s.getTokenLength());
                ...
                e
                    ? (l(
                        ...
                        l(
                            ...
                            aa.DuplicateKey,
                            e.keyNode.offset,
                            e.keyNode.offset + e.keyNode.length,
                            Vs.Warning,
                        ),
                        (n[i.value] = !0))
                    : (n[i.value] = r);
            ...
            if (6 === s.getToken()) ((r.colonOffset = s.getTokenOffset()), a());
                ...
                (u(ga("Colon expected"), aa.ColonExpected),
                    10 === s.getToken() &&
                    e.positionAt(i.offset + i.length).line <
                    e.positionAt(s.getTokenOffset()).line)
            )
                return ((r.length = i.length), r);
            const o = g(r);
            return o
                ? ((r.valueNode = o),
                    (r.length = o.offset + o.length - r.offset),
                    r)
                : u(ga("Value expected"), aa.ValueExpected, r, [], [2, 5]);
        }
        function m(e) {
            if (10 !== s.getToken()) return;
            const t = new La(e, s.getTokenOffset());
        ...
        function g(e) {
            return (
                (function (e) {
                    ...
                    const t = new Ca(e, s.getTokenOffset());
                    a();
                    let n = !1;
                    for (; 4 !== s.getToken() && 17 !== s.getToken();) {
                        if (5 === s.getToken()) {
                            n || u(ga("Value expected"), aa.ValueExpected);
                        ...
                        } else n && u(ga("Expected comma"), aa.CommaExpected);
                        const e = g(t);
                        (e
                            ? t.items.push(e)
                            : u(
                    ...
                    return 4 !== s.getToken()
                        ? u(
                            ga("Expected comma or closing bracket"),
                ...
                (function (e) {
                    ...
                    const t = new Na(e, s.getTokenOffset()),
                    ...
                    for (; 2 !== s.getToken() && 17 !== s.getToken();) {
                        if (5 === s.getToken()) {
                            r ||
                                u(ga("Property expected"), aa.PropertyExpected);
                            const e = s.getTokenOffset();
                            if ((a(), 2 === s.getToken())) {
                                r &&
                                    l(
                        ...
                        } else r && u(ga("Expected comma"), aa.CommaExpected);
                        const e = f(t, n);
                        (e
                            ? t.properties.push(e)
                            : u(
                                ga("Property expected"),
                                aa.PropertyExpected,
                                void 0,
                                [],
                                [2, 5],
                    ...
                    return 2 !== s.getToken()
                        ? u(
                            ga("Expected comma or closing brace"),
                ...
                (function (e) {
                    ...
                    const t = new _a(e, s.getTokenOffset());
                ...
                (function (e) {
                    switch (s.getToken()) {
                        case 7:
                            return h(new va(e, s.getTokenOffset()), !0);
                        case 8:
                            return h(new wa(e, !0, s.getTokenOffset()), !0);
                        case 9:
                            return h(new wa(e, !1, s.getTokenOffset()), !0);
                        default:
                            return;
                    }
                })(e)
        ...
        return (
            ...
            ((p = g(p)),
                p
                    ? 17 !== s.getToken() &&
                    u(ga("End of file expected."), aa.Undefined)
                    : u(
                        ga("Expected a JSON object, array or literal."),
                        aa.Undefined,
                    )),
            new Fa(p, n, o)
        );
        ...
        if (null !== e && "object" == typeof e) {
            ...
            }
            {
                ...
                for (let t = 0; t < i.length; t++) {
                    const o = i[t];
                    ((s += r + JSON.stringify(o) + ": " + Ka(e[o], r, n)),
                        t < i.length - 1 && (s += ","),
                        (s += "\n"));
                }
                return ((s += t + "}"), s);
    ...
    class $a {
                ...
                c = {
                    add: (e) => {
                        ...
                        if (n)
                            ...
                            ((e.textEdit = Bs.replace(l, e.insertText)),
                                (e.label = t),
                                u.set(t, e),
                                r.items.push(e));
                        }
                ...
                .then((t) => {
                    ...
                    if (o && "string" === o.type) {
                        ...
                        e &&
                            ...
                            ((f = !e.valueNode),
                                (d = e),
                                (m = i.substr(o.offset + 1, o.length - 2)),
                                e && (o = e.parent));
                    }
                    if (o && "object" === o.type) {
                        ...
                        o.properties.forEach((e) => {
                            (d && d === e) ||
                                u.set(e.keyNode.value, uo.create("__"));
                        });
                        let g = "";
                        (f &&
                            (g = this.evaluateSeparatorAfter(
                                e,
                                e.offsetAt(l.end),
                            )),
                            t
                                ? this.getPropertyCompletions(t, n, o, f, g, c)
                        ...
                        (this.contributions.forEach((t) => {
                            const n = t.collectPropertyCompletions(
                                e.uri,
                                p,
                                a,
                                f,
                    ...
                    return (
                        t
                            ? this.getValueCompletions(t, n, o, s, e, c, g)
                            : this.getSchemaLessValueCompletions(n, o, s, e, c),
                        ...
                        this.promiseConstructor.all(h).then(() => {
                        ...
                        Object.keys(t).forEach((e) => {
                            ...
                            if (
                                ...
                                const t = {
                                    ...
                                    documentation:
                                        this.fromMarkup(
                                            n.markdownDescription,
                                        ) ||
                                        n.description ||
                                        "",
                                };
                                (void 0 !== n.suggestSortText &&
                                    (t.sortText = n.suggestSortText),
                                    t.insertText &&
                                    ta(t.insertText, `$1${i}`) &&
                                    (t.command = {
                                        title: "Suggest",
                    ...
                    if (
                        ...
                        const e = (e, t = void 0) => {
                            const o = {
                                ...
                                documentation:
                                    t ||
                                    this.fromMarkup(n.markdownDescription) ||
                                    n.description ||
                                    "",
                            };
                            (void 0 !== n.suggestSortText &&
                                (o.sortText = n.suggestSortText),
                                o.insertText &&
                                ta(o.insertText, `$1${i}`) &&
                                (o.command = {
                                    title: "Suggest",
                        ...
                        if (n.enum)
                            for (let t = 0; t < n.enum.length; t++) {
                                let r;
                                (n.markdownEnumDescriptions &&
                                    t < n.markdownEnumDescriptions.length
                                    ? (r = this.fromMarkup(
                                        n.markdownEnumDescriptions[t],
                                    ))
                                    : n.enumDescriptions &&
                                    t < n.enumDescriptions.length &&
                                    (r = n.enumDescriptions[t]),
                                    e(n.enum[t], r));
                            }
                        n.const && e(n.const);
                    }
        ...
        getSchemaLessValueCompletions(e, t, n, r, i) {
            ...
            const o = this.evaluateSeparatorAfter(r, s),
                a = (e) => {
                    (e.parent &&
                        !Pa(e.parent, n, !0) &&
                        i.add({
                        ...
                        "boolean" === e.type &&
                        this.addBooleanValueCompletion(!e.value, o, i));
                };
            if ("property" === t.type && n > (t.colonOffset || 0)) {
                ...
                (e.visit(
                    ...
                    t.parent &&
                    !t.parent.parent &&
                    this.addDollarSchemaCompletions(o, i));
            }
            if ("array" === t.type)
        ...
        getValueCompletions(e, t, n, r, i, s, o) {
            ...
            if (
                ...
                if (n && (void 0 !== a || "array" === n.type)) {
                    const c = this.evaluateSeparatorAfter(i, u),
                        h = t.getMatchingSchemas(e.schema, n.offset, l);
                    for (const e of h)
                            ...
                            if ("array" === n.type && e.schema.items) {
                                ...
                                if (e.schema.uniqueItems) {
                                    ...
                                    (n.children.forEach((t) => {
                                        "array" !== t.type &&
                                            "object" !== t.type &&
                                            e.add(this.getLabelForValue(Oa(t)));
                                    }),
                                        (t = {
                                            ...s,
                                            add(t) {
                    ...
                    ("$schema" !== a ||
                        n.parent ||
                        this.addDollarSchemaCompletions(c, s),
                        o.boolean &&
                        (this.addBooleanValueCompletion(!0, c, s),
                            this.addBooleanValueCompletion(!1, c, s)),
                        o.null && this.addNullValueCompletion(c, s));
                }
        ...
        addSchemaValueCompletions(e, t, n, r) {
            "object" == typeof e &&
                (this.addEnumValueCompletions(e, t, n),
                    ...
                    e.allOf.forEach((e) =>
                        this.addSchemaValueCompletions(e, t, n, r),
                    ),
        ...
        addDefaultValueCompletions(e, t, n, r = 0) {
            ...
            if (Qo(e.default)) {
                ...
                (this.doesSupportsLabelDetails()
                    ? (a.labelDetails = { description: ga("Default value") })
                    : (a.detail = ga("Default value")),
                    n.add(a),
                    (i = !0));
            }
            (Array.isArray(e.examples) &&
                e.examples.forEach((s) => {
                    let o = e.type,
                        a = s;
                ...
                e.defaultSnippets.forEach((s) => {
                    ...
                    if (Qo(u)) {
                        ...
                        ((o = this.getInsertTextForSnippetValue(u, t)),
                            (a = this.getFilterTextForSnippetValue(u)),
                            (c = c || this.getLabelForSnippetValue(u)));
                    } else {
                    ...
                    (n.add({
                        ...
                        label: c,
                        documentation:
                            this.fromMarkup(s.markdownDescription) ||
                            s.description,
                        insertText: o,
                        insertTextFormat: io.Snippet,
                        filterText: a,
            ...
            if (
                (Qo(e.const) &&
                    n.add({
                        ...
                        insertTextFormat: io.Snippet,
                        documentation:
                            this.fromMarkup(e.markdownDescription) ||
                            e.description,
                    }),
        ...
        collectTypes(e, t) {
            if (Array.isArray(e.enum) || Qo(e.const)) return;
            const n = e.type;
        ...
        addDollarSchemaCompletions(e, t) {
            this.schemaService
                .getRegisteredSchemaIds((e) => "http" === e || "https" === e)
                .forEach((n) => {
                    (n.startsWith("http://json-schema.org/draft-") &&
                        (n += "#"),
                        t.add({
                            kind: ro.Module,
            ...
            if (t) {
                if (Array.isArray(t.defaultSnippets)) {
                    if (1 === t.defaultSnippets.length) {
                        ...
                        Qo(e) && (o = this.getInsertTextForSnippetValue(e, ""));
                    }
        ...
        findItemAtOffset(e, t, n) {
            const r = gs(t.getText(), !0),
                i = e.items;
            for (let s = i.length - 1; s >= 0; s--) {
                const e = i[s];
                if (n > e.offset + e.length) {
                    r.setPosition(e.offset + e.length);
                    return 5 === r.scan() &&
        ...
        isInComment(e, t, n) {
            const r = gs(e.getText(), !1);
            r.setPosition(t);
            let i = r.scan();
            for (; 17 !== i && r.getTokenOffset() + r.getTokenLength() < n;)
                i = r.scan();
            return (12 === i || 13 === i) && r.getTokenOffset() <= n;
        }
        fromMarkup(e) {
            if (e && this.doesSupportMarkdown())
                return { kind: to.Markdown, value: e };
        }
        doesSupportMarkdown() {
            if (!Qo(this.supportsMarkdown)) {
                const e =
                    this.clientCapabilities.textDocument?.completion
                        ?.completionItem?.documentationFormat;
                this.supportsMarkdown =
                    Array.isArray(e) && -1 !== e.indexOf(to.Markdown);
            }
            return this.supportsMarkdown;
        }
        doesSupportsCommitCharacters() {
            return (
                Qo(this.supportsCommitCharacters) ||
    ...
    class ja {
        ...
        configure(e) {
            e &&
                ((this.validationEnabled = !1 !== e.validate),
                    (this.commentSeverity = e.allowComments ? void 0 : Vs.Error));
        }
        doValidation(e, t, n, r) {
            ...
            const i = [],
                ...
                a = (r) => {
                    let s = n?.trailingCommas ? Ga(n.trailingCommas) : Vs.Error,
                        a = n?.comments ? Ga(n.comments) : this.commentSeverity,
                        l = n?.schemaValidation
                            ? Ga(n.schemaValidation)
                            : Vs.Warning,
                        u = n?.schemaRequest ? Ga(n.schemaRequest) : Vs.Warning;
                    if (r) {
                        const i = (n, r) => {
                            if (t.root && u) {
                                const i = t.root,
                        ...
                        if (r.errors.length)
                            i(r.errors[0], aa.SchemaResolveError);
                        else if (l) {
                            for (const e of r.warnings)
                                i(e, aa.SchemaUnsupportedFeature);
                            const s = t.validate(
                                e,
                                r.schema,
                                l,
                        ...
                        (za(r.schema) && (a = void 0),
                            Ha(r.schema) && (s = void 0));
                    }
                    for (const e of t.syntaxErrors) {
                        if (e.code === aa.TrailingComma) {
                    ...
                    if ("number" == typeof a) {
                        const e = ga("Comments are not permitted in JSON.");
                        t.comments.forEach((t) => {
                            o(Ks.create(t, e, a, aa.CommentNotPermitted));
                        });
                    }
                    return i;
                };
            if (r) {
                const e = r.id || "schemaservice://untitled/" + Wa++;
                return this.jsonSchemaService
                    .registerExternalSchema({ uri: e, schema: r })
                    .getResolvedSchema()
                    .then((e) => a(e));
            }
            return this.jsonSchemaService
    ...
    function za(e) {
        if (e && "object" == typeof e) {
            if (Zo(e.allowComments)) return e.allowComments;
            if (e.allOf)
    ...
    function Ha(e) {
        if (e && "object" == typeof e) {
            if (Zo(e.allowTrailingCommas)) return e.allowTrailingCommas;
            const t = e;
            if (Zo(t.allowsTrailingCommas)) return t.allowsTrailingCommas;
            if (e.allOf)
    ...
    function Xa(e) {
        if ("#" === e[0])
            switch (e.length) {
                case 4:
                    return {
                        red: (17 * Ja(e.charCodeAt(1))) / 255,
                        green: (17 * Ja(e.charCodeAt(2))) / 255,
                        blue: (17 * Ja(e.charCodeAt(3))) / 255,
                        alpha: 1,
                    };
                case 5:
                    return {
                        ...
                        green: (17 * Ja(e.charCodeAt(2))) / 255,
                        blue: (17 * Ja(e.charCodeAt(3))) / 255,
                        alpha: (17 * Ja(e.charCodeAt(4))) / 255,
                    };
                case 7:
                    return {
                        red:
                            (16 * Ja(e.charCodeAt(1)) + Ja(e.charCodeAt(2))) /
                            255,
                        green:
                            (16 * Ja(e.charCodeAt(3)) + Ja(e.charCodeAt(4))) /
                            255,
                        blue:
                            (16 * Ja(e.charCodeAt(5)) + Ja(e.charCodeAt(6))) /
                            255,
                        alpha: 1,
                    };
                case 9:
                    return {
                        ...
                        blue:
                            ...
                            255,
                        alpha:
                            (16 * Ja(e.charCodeAt(7)) + Ja(e.charCodeAt(8))) /
                            255,
                    };
            }
    }
    class Qa {
        ...
        findDocumentSymbols(e, t, n = { resultLimit: Number.MAX_VALUE }) {
            ...
            if (
                ("vscode://defaultsettings/keybindings.json" === s ||
                    ta(s.toLowerCase(), "/user/keybindings.json")) &&
                "array" === r.type
            ) {
                const t = [];
                for (const o of r.items)
                    if ("object" === o.type)
                        for (const r of o.properties)
                            if ("key" === r.keyNode.value && r.valueNode) {
                                const a = ks.create(e.uri, Za(e, o));
                                if (
                                    (t.push({
                                        name: Ya(r.valueNode),
                                        kind: yo.Function,
            ...
            const u = [],
                c = (t, n) => {
                    "array" === t.type
                        ? t.items.forEach((e) => {
                            e && o.push({ node: e, containerName: n });
                        })
                        : "object" === t.type &&
                        t.properties.forEach((t) => {
                            ...
                            if (r)
                                if (i > 0) {
                                    i--;
                                    const s = ks.create(e.uri, Za(e, t)),
                                        a = n
                                            ? n + "." + t.keyNode.value
                                            : t.keyNode.value;
                                    (u.push({
            ...
            return (
                l && n && n.onResultLimitExceeded && n.onResultLimitExceeded(s),
                u
            );
        }
        findDocumentSymbols2(e, t, n = { resultLimit: Number.MAX_VALUE }) {
                    ...
                    ? t.items.forEach((t, r) => {
                        if (t)
                            if (i > 0) {
                                ...
                                (n.push(l),
                                    a.push({ result: l.children, node: t }));
                            } else u = !0;
                    })
                    : "object" === t.type &&
                    t.properties.forEach((t) => {
                        ...
                        if (r)
                            if (i > 0) {
                                ...
                                (n.push(u), a.push({ result: l, node: r }));
                            } else u = !0;
                    });
            };
            for (; l < a.length;) {
            ...
            return (
                u && n && n.onResultLimitExceeded && n.onResultLimitExceeded(s),
                o
            );
        }
        getSymbolKind(e) {
                    ...
                    if (r) {
                        let s =
                            n && "number" == typeof n.resultLimit
                                ? n.resultLimit
                                : Number.MAX_VALUE;
                        const o = t.getMatchingSchemas(r.schema),
                            a = {};
                        for (const t of o)
                            if (
                                !t.inverted &&
                                t.schema &&
                                ("color" === t.schema.format ||
                                    "color-hex" === t.schema.format) &&
                                t.node &&
                                "string" === t.node.type
                            ) {
                                const r = String(t.node.offset);
                                if (!a[r]) {
                                    const o = Xa(Oa(t.node));
                                    if (o) {
                                        const n = Za(e, t.node);
                                        i.push({ color: o, range: n });
                                    }
                                    if (((a[r] = !0), s--, s <= 0))
                                        return (
                                            n &&
        ...
        getColorPresentations(e, t, n, r) {
            const i = [],
                ...
                o = Math.round(255 * n.green),
                a = Math.round(255 * n.blue);
            function l(e) {
                const t = e.toString(16);
                return 2 !== t.length ? "0" + t : t;
            }
            ...
            return (
                (u =
                    1 === n.alpha
                        ? `#${l(s)}${l(o)}${l(a)}`
                        : `#${l(s)}${l(o)}${l(a)}${l(Math.round(255 * n.alpha))}`),
                i.push({
                    label: u,
                    textEdit: Bs.replace(r, JSON.stringify(u)),
                }),
                i
            );
        }
    ...
    const el = {
        ...
        tl = {
            id: ga("A unique identifier for the schema."),
            $schema: ga("The schema to verify this document against."),
            title: ga("A descriptive title of the element."),
            description: ga(
                "A long description of the element. Used in hover menus and suggestions.",
            ),
            default: ga("A default value. Used by suggestions."),
            multipleOf: ga(
                "A number that should cleanly divide the current value (i.e. have no remainder).",
            ),
            maximum: ga("The maximum numerical value, inclusive by default."),
            exclusiveMaximum: ga("Makes the maximum property exclusive."),
            minimum: ga("The minimum numerical value, inclusive by default."),
            exclusiveMinimum: ga("Makes the minimum property exclusive."),
            maxLength: ga("The maximum length of a string."),
            minLength: ga("The minimum length of a string."),
            pattern: ga(
            ...
            enum: ga("The set of literal values that are valid."),
            type: ga(
            ...
            format: ga("Describes the format expected for the value."),
            allOf: ga("An array of schemas, all of which must match."),
            anyOf: ga("An array of schemas, where at least one must match."),
            oneOf: ga("An array of schemas, exactly one of which must match."),
            not: ga("A schema which must not match."),
            $id: ga("A unique identifier for the schema."),
            $ref: ga("Reference a definition hosted on any location."),
            $comment: ga(
    ...
    for (const Fl in el.schemas) {
        const e = el.schemas[Fl];
    ...
    (() => {
        ...
        ((() => {
                    ...
                    if (e) {
                        if (e instanceof c) return e;
                        {
                            ...
                            return (
                                ...
                                (t._fsPath = e._sep === h ? e.fsPath : null),
                                t
                            );
                        }
                    }
            ...
            class d extends c {
                ...
                get fsPath() {
                    return (
                        this._fsPath || (this._fsPath = p(this)),
                        this._fsPath
                    );
                }
                toString(e = !1) {
            ...
            !(function (e) {
                ((e.joinPath = function (e, ...t) {
                    return e.with({ path: _.join(e.path, ...t) });
                }),
                    ...
                    (e.dirname = function (e) {
                        if (0 === e.path.length || e.path === L) return e;
                        let t = _.dirname(e.path);
                        return (
                            1 === t.length &&
                            46 === t.charCodeAt(0) &&
                            (t = ""),
        ...
        getResolvedSchema() {
            return (
                ...
                (this.resolvedSchema = this.getUnresolvedSchema().then(
                    (e) => this.service.resolveSchemaContent(e, this),
                )),
                this.resolvedSchema
            );
        }
    ...
    class cl {
        ...
        onResourceChange(e) {
            ...
            let t = !1;
            const n = [(e = dl(e))],
                r = Object.keys(this.schemasById).map(
                    (e) => this.schemasById[e],
                );
            for (; n.length;) {
                const e = n.pop();
                for (let i = 0; i < r.length; i++) {
                    const s = r[i];
                    s &&
                        (s.uri === e || s.dependencies.has(e)) &&
                        (s.uri !== e && n.push(s.uri),
                            s.clearSchema() && (t = !0),
                            (r[i] = void 0));
                }
            }
        ...
        setSchemaContributions(e) {
            ...
            if (Array.isArray(e.schemaAssociations)) {
                ...
                for (let e of t) {
                    const t = e.uris.map(dl),
                        n = this.addFilePatternAssociation(
                            e.pattern,
                            e.folderUri,
                            t,
                        );
        ...
        registerExternalSchema(e) {
            ...
            return (
                ...
                e.fileMatch &&
                e.fileMatch.length &&
                this.addFilePatternAssociation(e.fileMatch, e.folderUri, [
                    t,
                ]),
                e.schema
                    ? this.addSchemaHandle(t, e.schema)
                    : this.getOrAddSchemaHandle(t)
            );
        }
        ...
        loadSchema(e) {
            if (!this.requestService) {
                ...
                return this.promise.resolve(new ll({}, [t]));
            }
            return (
        ...
        resolveSchemaContent(e, t) {
            const n = e.errors.slice(0),
                r = e.schema;
            let i = r.$schema ? dl(r.$schema) : void 0;
            if ("http://json-schema.org/draft-03/schema" === i)
                return this.promise.resolve(
                    new ul(
                        {},
                        [ga("Draft-03 schemas are not supported.")],
                        [],
                        i,
                    ),
                );
            ...
            const o = this.contextService,
                ...
                l = (e, t, r, i) => {
                    (o &&
                        ...
                        (t = o.resolveRelativePath(t, i.uri)),
                        (t = dl(t)));
                ...
                u = (e, t, n) => {
                    const r = [];
                    return (
                        this.traverseNodes(e, (e) => {
                            const i = new Set();
                            for (; e.$ref;) {
                                const s = e.$ref,
                                    o = s.split("#", 2);
                                if ((delete e.$ref, o[0].length > 0))
                                    return void r.push(l(e, o[0], o[1], n));
                                if (!i.has(s)) {
                                    const r = o[1];
                                    (a(e, t, n, r), i.add(s));
                                }
                            }
                            (e.$recursiveRef && s.add("$recursiveRef"),
                                e.$dynamicRef && s.add("$dynamicRef"));
                        }),
                        this.promise.all(r)
                    );
                },
                        ...
                        this.traverseNodes(e, (e) => {
                            ...
                            (i &&
                                (t.has(i)
                                    ...
                                    : t.set(i, e)),
                                e.$recursiveAnchor && s.add("$recursiveAnchor"),
                                e.$dynamicAnchor && s.add("$dynamicAnchor"));
                        }),
                        t
                    );
                };
        ...
        traverseNodes(e, t) {
            ...
            const n = new Set(),
                r = (...e) => {
                    for (const t of e) ea(t) && a.push(t);
                },
                i = (...e) => {
                    for (const t of e)
                        if (ea(t))
                ...
                s = (...e) => {
                    for (const t of e)
                        if (Array.isArray(t))
                            for (const e of t) ea(e) && a.push(e);
                },
                o = (e) => {
                    if (Array.isArray(e)) for (const t of e) ea(t) && a.push(t);
                    else ea(e) && a.push(e);
                },
                a = [e];
            let l = a.pop();
            for (; l;)
                (n.has(l) ||
                    (n.add(l),
                        ...
                        s(l.anyOf, l.allOf, l.oneOf, l.prefixItems),
                        o(l.items)),
                    (l = a.pop()));
        }
        getSchemaFromProperty(e, t) {
            if ("object" === t.root?.type)
                for (const n of t.root.properties)
                    if (
                        "$schema" === n.keyNode.value &&
                        "string" === n.valueNode?.type
                    ) {
                        let t = n.valueNode.value;
                        return (
                            this.contextService &&
                            !/^\w[\w\d+.-]*:/.test(t) &&
                            (t = this.contextService.resolveRelativePath(
                                t,
                                e,
                            )),
                            t
        ...
        getSchemaForResource(e, t) {
            ...
            const n = this.getAssociatedSchemas(e),
                r =
                    n.length > 0
                        ? this.createCombinedSchema(e, n).getResolvedSchema()
        ...
        getMatchingSchemas(e, t, n) {
            if (n) {
                const e =
                    n.id || "schemaservice://untitled/matchingSchemas/" + hl++;
            ...
            return this.getSchemaForResource(e.uri, t).then((e) =>
                e
                    ? t.getMatchingSchemas(e.schema).filter((e) => !e.inverted)
                    : [],
            );
        }
    }
    ...
    function gl(e, t) {
        ...
        for (; 17 !== a;) {
            switch (a) {
                case 1:
                case 3: {
                    const t = e.positionAt(o.getTokenOffset()).line,
                        n = {
                            startLine: t,
                            endLine: t,
                ...
                case 4: {
                    ...
                    if (i.length > 0 && i[i.length - 1].kind === t) {
                        const t = i.pop(),
                            n = e.positionAt(o.getTokenOffset()).line;
                        t &&
                            n > t.startLine + 1 &&
                            s !== t.startLine &&
                            ((t.endLine = n - 1), l(t), (s = t.startLine));
                    }
                    break;
                }
                case 13: {
                    ...
                    1 === o.getTokenError() && t + 1 < e.lineCount
                        ? o.setPosition(e.offsetAt(Es.create(t + 1, 0)))
                        : t < n &&
                        (l({ startLine: t, endLine: n, kind: Is.Comment }),
                            (s = t));
                    break;
                }
                case 12: {
    ...
    function pl(e, t, n) {
        function r(t, n) {
            return As.create(e.positionAt(t), e.positionAt(n));
        }
        const i = gs(e.getText(), !0);
        function s(e, t) {
            return (
                i.setPosition(e),
        ...
        return t.map(function (t) {
            ...
            for (; o;) {
                switch (o.type) {
                    ...
                    case "array":
                        const e = o.offset + 1,
                            t = o.offset + o.length - 1;
                        (e < t && i >= e && i <= t && a.push(r(e, t)),
                            a.push(r(o.offset, o.offset + o.length)));
                        break;
                    case "number":
                    case "boolean":
                    case "null":
            ...
            let l;
            for (let e = a.length - 1; e >= 0; e--) l = Ro.create(a[e], l);
            return (l || (l = Ro.create(As.create(t, t))), l);
        });
    }
    function bl(e, t, n) {
        let r;
        if (n) {
            ...
            r = { offset: t, length: e.offsetAt(n.end) - t };
        }
        const i = {
    ...
    class vl {
        ...
        addChildProperty(e) {
            if (((e.parent = this), this.childrenProperties.length > 0)) {
                let t = 0;
                ((t = e.noKeyName
                    ? this.childrenProperties.length
                    : (function (e, t, n) {
                        const r = t.propertyName.toLowerCase(),
                        ...
                        return -o - 1;
                    })(this.childrenProperties, e, wl)),
                    t < 0 && (t = -1 * t - 1),
                    this.childrenProperties.splice(t, 0, e));
            } else this.childrenProperties.push(e);
            return e;
        }
    }
    function wl(e, t) {
        const n = e.propertyName.toLowerCase(),
            r = t.propertyName.toLowerCase();
        return n < r ? -1 : n > r ? 1 : 0;
    }
    function Cl(e, t) {
        const n = { ...t, keepLines: !1 },
            r = oa.applyEdits(e, bl(e, n, void 0)),
            i = oa.create("test://test.json", "json", 0, r),
            s = (function (e, t) {
                if (0 === t.childrenProperties.length) return e;
                const n = oa.create("test://test.json", "json", 0, e.getText()),
                    r = [];
                _l(r, t, t.beginningLineNumber);
                for (; r.length > 0;) {
                    const t = r.shift(),
                    ...
                    for (let o = 0; o < i.length; o++) {
                        const t = i[o],
                            a = As.create(
                                Es.create(t.beginningLineNumber, 0),
                                Es.create(t.endLineNumber + 1, 0),
                            ),
                            l = e.getText(a),
                            u = oa.create("test://test.json", "json", 0, l);
                        if (!0 === t.lastProperty && o !== i.length - 1) {
                            const e =
                                t.lineWhereToAddComma -
                                t.beginningLineNumber,
                                n = t.indexWhereToAddComa,
                                r = {
                                    range: As.create(
                                        Es.create(e, n),
                                        Es.create(e, n),
                            ...
                            const e = t.commaIndex,
                                n = t.commaLine - t.beginningLineNumber,
                                r = {
                                    range: As.create(
                                        Es.create(n, e),
                                        Es.create(n, e + 1),
                        ...
                        const c = t.endLineNumber - t.beginningLineNumber + 1,
                            h = {
                                range: As.create(
                                    Es.create(s, 0),
                                    Es.create(s + c, 0),
                    ...
                    for (; 17 !== (r = n.scan());) {
                        ...
                        if (
                            (!0 === y &&
                                ...
                                12 !== r &&
                                13 !== r &&
                                ((m = n.getTokenStartLine()), (y = !1)),
                                n.getTokenStartLine() !== c)
                        ) {
                        ...
                        switch (r) {
                            case 10:
                                if (
                                    void 0 === i ||
                                    1 === i ||
                                    (5 === i && p[p.length - 1] === yl.Object)
                                ) {
                                    const e = new vl(n.getTokenValue(), m);
                                    ((u = l), (l = a.addChildProperty(e)));
                                }
                                break;
                            case 3:
                                if (
                                    (void 0 === o.beginningLineNumber &&
                                        (o.beginningLineNumber =
                                            n.getTokenStartLine()),
                                        p[p.length - 1] === yl.Object)
                                )
                                    a = l;
                                else if (p[p.length - 1] === yl.Array) {
                                    const e = new vl(n.getTokenValue(), m);
                                    ((e.noKeyName = !0),
                                        (u = l),
                                        (l = a.addChildProperty(e)),
                                        (a = l));
                                }
                                (p.push(yl.Array),
                                    (l.type = yl.Array),
                                ...
                                break;
                            case 1:
                                if (void 0 === o.beginningLineNumber)
                                    o.beginningLineNumber =
                                        n.getTokenStartLine();
                                else if (p[p.length - 1] === yl.Array) {
                                    const e = new vl(n.getTokenValue(), m);
                                ...
                                break;
                            case 4:
                                ((g = n.getTokenStartLine()),
                                    p.pop(),
                                    void 0 !== l.endLineNumber ||
                                    (2 !== i && 4 !== i) ||
                                    ((l.endLineNumber = g - 1),
                                        (l.lastProperty = !0),
                                        (l.lineWhereToAddComma = d),
                                        (l.indexWhereToAddComa = f),
                                        (u = l),
                                        (l = l ? l.parent : void 0),
                                        (a = l)),
                                    (o.endLineNumber = g),
                            ...
                            case 2:
                                ((g = n.getTokenStartLine()),
                                    ...
                                    (void 0 === l.endLineNumber &&
                                        ...
                                        (l = l ? l.parent : void 0),
                                        (a = l)),
                                    (o.endLineNumber = n.getTokenStartLine()),
                                    (m = g + 1));
                                break;
                            case 5:
                                ((g = n.getTokenStartLine()),
                                    void 0 !== l.endLineNumber ||
                                    (p[p.length - 1] !== yl.Object &&
                                        (p[p.length - 1] !== yl.Array ||
                                            (2 !== i && 4 !== i))) ||
                                    ((l.endLineNumber = g),
                                        (l.commaIndex = n.getTokenOffset() - h),
                                        (l.commaLine = g)),
                                    (2 !== i && 4 !== i) ||
                                    ((u = l),
                                        (l = l ? l.parent : void 0),
                        ...
                        14 !== r &&
                            ...
                            ((s = i),
                                (i = r),
                                (d = n.getTokenStartLine()),
                                (f = n.getTokenOffset() + n.getTokenLength() - h));
                    }
                    return o;
                })(i),
            ),
        ...
        return [
            Bs.replace(
                As.create(Es.create(0, 0), e.positionAt(e.getText().length)),
                a,
            ),
        ];
    }
    function _l(e, t, n) {
        if (0 !== t.childrenProperties.length)
            if (t.type === yl.Object) {
                let r = 1 / 0;
                for (const e of t.childrenProperties)
                    e.beginningLineNumber < r && (r = e.beginningLineNumber);
                ((n += r - t.beginningLineNumber),
                    e.push(new Sl(n, t.childrenProperties)));
            } else t.type === yl.Array && Ll(e, t, n);
    }
    function Ll(e, t, n) {
        for (const r of t.childrenProperties) {
            if (r.type === yl.Object) {
                let i = 1 / 0;
                for (const e of r.childrenProperties)
                    e.beginningLineNumber < i && (i = e.beginningLineNumber);
                const s = i - r.beginningLineNumber;
                e.push(
                    new Sl(
                        n + r.beginningLineNumber - t.beginningLineNumber + s,
                        r.childrenProperties,
                    ),
                );
            }
            r.type === yl.Array &&
                Ll(e, r, n + r.beginningLineNumber - t.beginningLineNumber);
        }
    }
    class Sl {
        constructor(e, t) {
                    ...
                    const i = r.valueNode.value,
                        s = (function (e, t) {
                            const n = (function (e) {
                                ...
                                return e.substring(2).split(/\//).map(Al);
                            })(t);
                            if (!n) return null;
                            return El(n, e.root);
                        })(t, i);
    ...
    function kl(e) {
        const t = e.promiseConstructor || Promise,
            n = new cl(e.schemaRequestService, e.workspaceContext, t);
        n.setSchemaContributions(el);
        const r = new $a(n, e.contributions, t, e.clientCapabilities),
            i = new Ba(n, e.contributions, t),
            s = new Qa(n),
            o = new ja(n, t);
        return {
            configure: (e) => {
                (n.clearExternalSchemas(),
                    e.schemas?.forEach(n.registerExternalSchema.bind(n)),
                    o.configure(e));
            },
            resetSchema: (e) => n.onResourceChange(e),
            doValidation: o.doValidation.bind(o),
            getLanguageStatus: o.getLanguageStatus.bind(o),
            parseJSONDocument: (e) => qa(e, { collectComments: !0 }),
            newJSONDocument: (e, t) =>
                (function (e, t = []) {
                    return new Fa(e, t, []);
                })(e, t),
            ...
            getFoldingRanges: gl,
            getSelectionRanges: pl,
            findDefinition: () => Promise.resolve([]),
            findLinks: Nl,
            format: (e, t, n) => bl(e, n, t),
            sort: (e, t) => Cl(e, t),
        };
    }
    let Rl;
    ...
    class Tl {
        constructor(e, t) {
            ((this._ctx = e),
                ...
                (this._languageService = kl({
                    workspaceContext: {
                        resolveRelativePath: (e, t) =>
                            (function (e, t) {
                                if (
                                    (function (e) {
                                        return e.charCodeAt(0) === Ml;
                                    })(t)
                                ) {
                                    const n = rl.parse(e),
                                        r = t.split("/");
                                    return n.with({ path: Il(r) }).toString();
                                }
                                return (function (e, ...t) {
                                    const n = rl.parse(e),
                                        r = n.path.split("/");
                    ...
                    schemaRequestService: t.enableSchemaRequest ? Rl : void 0,
                    clientCapabilities: ua.LATEST,
                })),
        ...
        async getColorPresentations(e, t, n) {
            ...
            let i = this._languageService.parseJSONDocument(r),
                s = this._languageService.getColorPresentations(r, i, t, n);
    ...
    const Ml = "/".charCodeAt(0),
        Ol = ".".charCodeAt(0);
    function Il(e) {
        const t = [];
        for (const r of e)
            0 === r.length ||
                (1 === r.length && r.charCodeAt(0) === Ol) ||
                (2 === r.length &&
                    r.charCodeAt(0) === Ol &&
                    r.charCodeAt(1) === Ol
                    ? t.pop()
