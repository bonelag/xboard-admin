  ...
  "settings": {
    ...
    "telegram": {
      ...
      "webhook_url": {
        ...
        "description": "Only provide the base URL here. The system will append the full Telegram webhook callback path automatically. Leave blank to use the site URL.",
        "docs": "View Telegram Webhook Docs",
